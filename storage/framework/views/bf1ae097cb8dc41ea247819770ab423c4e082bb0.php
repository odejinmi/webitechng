        ...
        <div class="card mt-5">
            <div class="card-body">
                <form action="<?php echo e(route('admin.setting.notification.global.update')); ?>" method="POST">
                    ...
                    <button type="submit" class="btn w-100 btn-outline-primary h-45"><?php echo app('translator')->get('Submit'); ?></button>
                </form>
            </div>
        </div><!-- card end -->
    </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/billspaypoint/core/resources/views/admin/notification/global_template.blade.php ENDPATH**/ ?>