<div class="d-none d-lg-flex py-3">
                ...
                <div class="hstack flex-fill justify-content-end flex-nowrap gap-6 ms-auto px-6 px-xxl-8">
                        ...
                        <div class="dropdown-menu dropdown-menu-end px-2" aria-labelledby="dropdown-notifications">
                            ...
                            <?php
                                ...
                                ?>
                                  ...
                                  <?php $__empty_1 = true; $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $support): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <div class="dropdown-item py-3 d-flex">
                                ...
                                <div class="flex-fill ms-3">
                                    <div class="text-sm lg-snug w-rem-64 text-wrap"><a href="#"
                                        ...
                                        message to <a href="<?php echo e(route('ticket.view', $support->ticket)); ?>"
                                            class="fw-semibold text-heading text-primary-hover"><?php echo e(__($support->subject)); ?></a></div>
                                    <span class="text-muted text-xs"><?php echo e(\Carbon\Carbon::parse($support->last_reply)->diffForHumans()); ?></span>
                                </div>
                            </div>
                            ...
                            <div class="dropdown-item py-2 text-center"><a href="<?php echo e(route('ticket.index')); ?>"
                    ...
                    <div class="dropdown"><a class="avatar avatar-sm text-bg-dark rounded-circle" href="#" role="button"
                            ...
                            aria-expanded="false"><img src="<?php echo e(getImage(getFilePath('userProfile') . '/' . auth()->user()->image, getFileSize('userProfile'))); ?>"></a>
                        <div class="dropdown-menu dropdown-menu-end">
                            <div class="dropdown-header">
                                <span class="d-block text-sm text-muted mb-1">Signed in as</span>
                                <span class="d-block text-heading fw-semibold"><?php echo e(Auth::user()->fullname); ?></span></div>
                            <div class="dropdown-divider"></div><a class="dropdown-item"
                                href="<?php echo e(route('user.home')); ?>"><i class="bi bi-house me-3"></i>Home </a><a class="dropdown-item"
                                href="<?php echo e(route('user.profile.setting')); ?>"><i class="bi bi-pencil me-3"></i>Edit profile</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item"
                                href="<?php echo e(route('user.kyc.index')); ?>"><i class="bi bi-image me-3"></i>KYC </a><a class="dropdown-item"
                                href="<?php echo e(route('ticket.index')); ?>"><i class="bi bi-box-arrow-up me-3"></i>Help</a>
                            <div class="dropdown-divider"></div><a class="dropdown-item"
                                href="<?php echo e(route('user.logout')); ?>"><i class="bi bi-person me-3"></i>Logout</a>
                        </div>
                    </div>
                </div>
            </div>
          <?php /**PATH C:\Users\DELL\PhpstormProjects\webitechng\resources\views/templates/satoshi/partials/topnav.blade.php ENDPATH**/ ?>