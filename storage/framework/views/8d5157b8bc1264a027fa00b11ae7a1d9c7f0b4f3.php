                                    ...
                                    <tr>
                                      ...
                                      <td> 
                                        ...
                                        <td>
                                          ...
                                          <a href="<?php echo e(route('user.requestaccount.confirm',encrypt($deposit->trx))); ?>" class="btn btn-sm btn-primary">Make Payment</a>
                                          <a href="<?php echo e(route('user.requestaccount.cancel',encrypt($deposit->trx))); ?>" class="btn btn-sm btn-danger">Cancel Request</a>
                                          <?php endif; ?>
                                        </td>
                                    </tr>
...
<?php echo $__env->make($activeTemplate . 'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/billspaypoint/core/resources/views/templates/basic/user/vendor/request_account/history.blade.php ENDPATH**/ ?>