                          ...
                          <tbody>
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = @$log; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deposit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                           <small> <?php echo e(showAmount($deposit->payment)); ?><?php echo e(__(@$deposit->asset->symbol)); ?></small>
                                            <br> 
                                            <strong><?php echo e(showAmount($deposit->price)); ?> <?php echo e(__($deposit->currency)); ?></strong>                                        
                                        </td>
                                        <td class="text-center">
                                          <?php echo e(__($deposit->value)); ?><?php echo e(__($general->cur_text)); ?>

                                        </td> 
                                        <td class="text-center">
                                           <label class='badge text-white  <?php if($deposit->status_code == 1 || $deposit->status_code == 3 || $deposit->status == 'success'): ?> bg-success <?php else: ?> bg-warning <?php endif; ?>'> <?php echo $deposit->status ?></label>
                                        ...
                                        <div class="modal-body p-4">
                                          <div class="text-center text-success">
                                            ...
                                            <p class="mt-3 text-success-50">
                                              <?php echo app('translator')->get('You are about to approve this transaction. Please click on the continue button below to continue process'); ?>
                                            </p>
                                            <button type="button" class="btn btn-light my-2"  data-bs-dismiss="modal">
                                              Cancel
                                            </button>
                                            <a href="<?php echo e(route('admin.crypto.assetselltrade.approve',$deposit->trx)); ?>" class="btn btn-success my-2">
                                              Continue
                                            </a>
                                          </div>
                                        </div>
                                      ...
                                      >
                                        <div class="modal-body p-4">
                                          <div class="text-center text-danger">
                                            ...
                                            <a href="<?php echo e(route('admin.crypto.assetselltrade.decline',$deposit->trx)); ?>" class="btn btn-danger my-2">
                                              Continue
                                            </a>
                                          </div>
                                        </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/billspaypoint/core/resources/views/admin/currency/sell_log.blade.php ENDPATH**/ ?>