<?php $__env->startSection('content'); ?>
            ...
            <div class="row d-flex align-items-center m-row">
                ...
                <div class="col-md-7 col-lg-6 m-top">
                    <div class="hero-3-txt pc-10 mb-40 wow fadeInRight" data-wow-delay="0.4s">
                        ...
                        <!-- Title -->
                        <h2 class="h2-xl">Built For Convenience</h2>

                        <!-- Text -->
                        <p class="p-md"><?php echo e($general->site_name); ?> makes it safe and easy to buy and sell Cryptocurrencies, Trade Gift card, shop with our Virtual USD and NGN dollar card, savings with interest and enjoy other bill payment services such as Cable, Electricity,Insurance, data and Airtime all using your local currency.
                        </p>
            ...
            <div class="row d-flex align-items-center">
                ...
                <div class="col-md-7 col-lg-6">
                    <div class="txt-block right-column pc-30 mb-40 wow fadeInLeft" data-wow-delay="0.4s">
                        ...
                        <!-- Title -->
                        <h3 class="h3-sm">Trade Crypto With Convenience</h3>
                        ...
                        <ul class="simple-list grey-color">
                            ...
                            <li class="list-item">
                                <p class="p-md">With LTechNG, you can trade cryptocurrencies confidently, knowing that your transactions are protected by robust security measures, safeguarding your assests and personal information
                                </p>
                            </li>

                            <li class="list-item">
                                <p class="p-md">Beyond Trading, LtechNG offers a range of additional services such as Gift card Trades, Bill Payment, Virtual USD Cards, Savings Plan and a host of other needs that are met in a convenient platform
                                </p>
                            </li>
                        ...
                        <!-- Button -->
                        <a href="<?php echo e(route('user.home')); ?>" class="btn btn-md btn-tra-grey theme-hover">Get Started</a>
            ...
            <div class="row">
                <div class="col-lg-10 offset-lg-1">
                    <div class="section-title text-center mb-60">
                        ...
                        <!-- Title -->
                        <h2 class="h2-xs">Why Choose <?php echo e($general->site_name); ?></h2>

                        <!-- Text -->
                        <p class="p-xl">Choose LTechNG for its comprehensive suite of Diverse services covering eveything, all convenietly accessible in one platform
                        </p>
                    ...
                    <div class="col-md-6">
                        <div class="fbox-3 pc-25 mb-40 wow fadeInUp" data-wow-delay="0.4s">
                            ...
                            <div class="fbox-txt">
                                ...
                                <!-- Text -->
                                <p class="p-md grey-color">Choosing LtechNG for a savings plan means more personalized options, competitive interest rates and convinient features, ultimately helping you reach your financial goal efficiently.
                                </p>
                    ...
                    <div class="col-md-6">
                        <div class="fbox-3 pc-25 mb-40 wow fadeInUp" data-wow-delay="0.6s">
                            ...
                            <div class="fbox-txt">
                                ...
                                <!-- Text -->
                                <p class="p-md grey-color">LtechNg's Crypto Wallet offers secure, user-friendly management for digital assets with multi-currency support, robust security and potential DeFi integration
                                </p>
                    ...
                    <div class="col-md-6">
                        <div class="fbox-3 pc-25 mb-40 wow fadeInUp" data-wow-delay="1.4s">
                            ...
                            <div class="fbox-txt">
                                ...
                                <!-- Text -->
                                <p class="p-md grey-color">LTechNG ensures concrete security measures, safeguarding user data and transactins through encryption,authentication protocols and proactive monitoring for threats
                                </p>
                ...
                <div class="row d-flex align-items-center m-row">
                    ...
                    <div class="col-md-7 col-lg-6 m-bottom">
                        <div class="txt-block left-column pc-30 mb-40 wow fadeInRight" data-wow-delay="0.6s">
                            ...
                            <!-- Title -->
                            <h3 class="h3-sm">Sync All Your Bill Payment Needs with LTechNG</h3>

                            <!-- Text -->
                            <p class="p-md grey-color">Syncing all your bill payment needs with LTechNG sounds like a convenient solution!
                            </p>
                    ...
                    <div class="col-md-7 col-lg-6">
                        <div class="txt-block right-column pc-30 mb-40 wow fadeInLeft" data-wow-delay="0.6s">
                            ...
                            <ul class="simple-list grey-color">
                                ...
                                <li class="list-item">
                                    <p class="p-md"> <strong>Gift Card:</strong>With LtechNG's gift card services, you can easily purchase gift cards for your favorite people,allowing you to treat them to their favorite stores or experiences
                                    </p>
                                </li>

                                <li class="list-item">
                                    <p class="p-md"><strong>Virtual Cards:</strong> LtechNG's Virtual Card feature enambles you to send virtual prepaid cards(USD/NGN) to your loved ones, providing them with a convenient and secure way to make onlibe purchases or manage expenses</p>
                                </li>

                                <li class="list-item">
                                    <p class="p-md"><strong>Savings:</strong> Utilize LtechNG's savings tools to set aside funds for special occasions of future gifts, ensuring that you can always show your appreciation to your favorite people when the time comes
                                    </p>
                                </li>
    ...
    <!-- STATISTIC-2
       ============================================= -->
    <section id="statistic-2" class="bg-03w wide-60 statistic-section division" style="background:#30003D;">
            ...
            <div class="row">
                <div class="col-lg-10 offset-lg-1">
                    <div class="section-title text-center mb-60">
                        ...
                        <!-- Text -->
                        <p class="p-xl">Start trading on <?php echo e($general->site_name); ?> with these 3 easy steps
                        </p>
    ...
    <!-- FEATURES-9
       ============================================= -->
    <section id="features-9" class="pb-60 features-section division">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-10 offset-lg-1">
                    <div class="section-title text-center mb-60">
                        ...
                        <!-- Title -->
                        <h2 class="h2-xs">Security, Simplicity, Easiness</h2>

                        <!-- Text -->
                        <p class="p-xl">With a focus on seamless experiences, robust protection, and effortless usability, LtechNg prioritizes technology solutions that embody security, simplicity and easiness.
                        </p>
                    ...
                    <div class="col-md-12">
                        <div class="video-preview">
                            ...
                            <a class="video-popup1" #">
                                <div class="video-btn video-btn-lg bg-theme ico-75">
            ...
            <div class="row">
                <div class="col-lg-10 offset-lg-1">
                    <div class="section-title text-center mb-60">
                        ...
                        <!-- Text -->
                        <p class="p-xl">Become a part of our ever growing community.
                        </p>
                ...
                <div class="col-md-12">
                    <div class="owl-carousel owl-theme reviews-wrapper">
                        ...
                        <div class="review-2 radius-08">
                            ...
                            <!-- Title -->
                            <h5 class="h5-xs">Awesome Design!</h5>

                            <!-- Testimonial Text -->
                            <div class="review-2-txt">

                                <!-- Text -->
                                <p class="p-md grey-color">Cool design and easy to trade crypto"
                                </p>

                                <!-- Testimonial Author -->
                                <h6 class="h6-sm">- John Ojevwe</h6>
                        ...
                        <div class="review-2 radius-08">
                            ...
                            <!-- Title -->
                            <h5 class="h5-xs">Simply an Amazing App</h5>

                            <!-- Testimonial Text -->
                            <div class="review-2-txt">

                                <!-- Text -->
                                <p class="p-md grey-color">I'm already making cool money using all the features available on the website
                                You guys should open up a reseller portal so i can make more money
                                </p>

                                <!-- Testimonial Author -->
                                <h6 class="h6-sm">- Adewale L.</h6>
                        ...
                        <div class="review-2 radius-08">
                            ...
                            <!-- Title -->
                            <h5 class="h5-xs">Super Customer Support</h5>

                            <!-- Testimonial Text -->
                            <div class="review-2-txt">

                                <!-- Text -->
                                <p class="p-md grey-color">I must say, i had a splendid time chatting with their ever listening rep.
                                Guy seemes quite knowledgeable in fixing my 2FA issues
                                </p>

                                <!-- Testimonial Author -->
                                <h6 class="h6-sm">- Tolani T.</h6>
                        ...
                        <div class="review-2 radius-08">
                            ...
                            <!-- Title -->
                            <h5 class="h5-xs">Solid</h5>

                            <!-- Testimonial Text -->
                            <div class="review-2-txt">

                                <!-- Text -->
                                <p class="p-md grey-color">I shop online knowing with their virtual card
                                knowing my transactions will always be successful

                                <!-- Testimonial Author -->
                                <h6 class="h6-sm">- AJ</h6>
                        ...
                        <div class="review-2 radius-08">
                            ...
                            <!-- Title -->
                            <h5 class="h5-xs">Legit Stuff</h5>

                            <!-- Testimonial Text -->
                            <div class="review-2-txt">

                                <!-- Text -->
                                <p class="p-md grey-color">Their interner data deals are unbeatable, I stay connected all month without emptying my pockets.
                                </p>

                                <!-- Testimonial Author -->
                                <h6 class="h6-sm">- Adewale James</h6>
                        ...
                        <div class="review-2 radius-08">
                            ...
                            <!-- Title -->
                            <h5 class="h5-xs">Simply Simple and Useful!</h5>

                            <!-- Testimonial Text -->
                            <div class="review-2-txt">

                                <!-- Text -->
                                <p class="p-md grey-color">Paying bills on Ltechng is smooth as silk
                                I handle my utilities with ease, no network hang, no stress> They got you covered
                                </p>

                                <!-- Testimonial Author -->
                                <h6 class="h6-sm">- Sandra Ese.</h6>
                        ...
                        <div class="review-2 radius-08">
                            ...
                            <!-- Title -->
                            <h5 class="h5-xs">I love this App!</h5>

                            <!-- Testimonial Text -->
                            <div class="review-2-txt">

                                <!-- Text -->
                                <p class="p-md grey-color">Buying and selling giftcards on their platform is a smooth ride.
                                    Very reliable. No"mama shoot bird, pickin fly" story. Transactions and payment dey move like breeze
                                </p>

                                <!-- Testimonial Author -->
                                <h6 class="h6-sm">- Orighoye Godfrey</h6>
                        ...
                        <div class="review-2 radius-08">
                            ...
                            <!-- Title -->
                            <h5 class="h5-xs">Cants ask for more</h5>

                            <!-- Testimonial Text -->
                            <div class="review-2-txt">

                                <!-- Text -->
                                <p class="p-md grey-color">AI like the fact that you can do a whole lot on the site.
                                </p>

                                <!-- Testimonial Author -->
                                <h6 class="h6-sm">- Nneka Onu /h6>
...
<?php echo $__env->make($activeTemplate . 'layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DELL\PhpstormProjects\webitechng\resources\views/templates/basic/home.blade.php ENDPATH**/ ?>