                            ...
                            <div data-kt-stepper-element="scontent">
                                ...
                                <div class="w-100">
                                    ...
                                    <div class="pb-10 pb-lg-15">
                                        <!--begin::Title-->
                                        <h2 class="fw-bold text-dark"><?php echo app('translator')->get('Bank Transfer'); ?></h2>
                                        <!--end::Title-->
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        <input type="number" id="amount"
                                            class="form-control form-control-lg form-control-solid  amount <?php $__errorArgs = ['amount'];
...
unset($__errorArgs, $__bag); ?>"
                                            value="<?php echo e(old('amount')); ?>" name="amount" placeholder="0.00" />
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Input group-->
                                    ...
                                    <div class="mb-10 fv-row">
                                        <!--begin::Label-->
                                        <label class="form-label mb-3"><?php echo app('translator')->get('Recipient\'s Bank'); ?></label>
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                    ...
                                    <div class="mb-10 fv-row">
                                        <!--begin::Label-->
                                        <label class="form-label mb-3"><?php echo app('translator')->get('Account Number'); ?></label>
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input type="text" onkeyup="validatebank()"
                                            class="form-control form-control-lg form-control-solid  username <?php $__errorArgs = ['account'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                            id="account" name="account" value="<?php echo e(old('account')); ?>"
                                    ...
                                    <div id="beneficiary"></div>
                                      ...
                                      <div class="mb-10 fv-row">
                                        <!--begin::Label-->
                                        <label class="form-label mb-3"><?php echo app('translator')->get('Narration'); ?></label>
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input type="text"
                                            class="form-control form-control-lg form-control-solid  username <?php $__errorArgs = ['account'];
...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        <label class="form-label mb-3"
                                            data-kt-translate="two-step-label"><?php echo app('translator')->get('Type your 6 digit transaction code'); ?></label>
                                        <!--end::Label-->
                            ...
                            <div class="d-flex flex-stack pt-15">
                                ...
                                <div>
                                    ...
                                    <button type="button" disabled onclick="sendmoney()" class="btn btn-lg btn-primary"
                                        id="submit"><?php echo app('translator')->get('Proceed'); ?>
        ...
        <?php $__env->startPush('script'); ?>
            ...
            <script>
                function validatebank() {
                    ...
                    fetch("<?php echo e(route('user.bank.validate.blochq')); ?>", requestOptions)
            ...
            fetch("<?php echo e(route('user.bank.transfer.blochq')); ?>", requestOptions)
                .then(response => response.text())
                .then(result => {
                    const reply = JSON.parse(result); 
                        document.getElementById("submit").disabled = false;
    ...
    <?php $__env->stopPush(); ?>
<?php echo $__env->make($activeTemplate . 'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ltecyxtc/public_html/core/resources/views/templates/basic/user/bank/blochq.blade.php ENDPATH**/ ?>