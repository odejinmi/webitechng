        ...
        <div class="container">
            ...
            <div class="shop-detail">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="shop-content">
                                    ...
                                    <form role="form" method="POST" action="<?php echo e(route('user.giftcard.auto.buy',4)); ?>">
                                    ...
                                    <div class="d-sm-flex align-items-center gap-3 pt-8 mb-7">
                                        <button type="submit" class="btn d-block btn-primary px-5 py-8 mb-2 mb-sm-0"><?php echo app('translator')->get('Checkout'); ?></button>
                                        <div id="loading"></div>
                                    </div>
                                    </form>
                                </div>
                ...
                <div class="related-products pt-7 d-none" id="showrelatedproduct">
                    <h4 class="mb-3 fw-semibold"><?php echo app('translator')->get('Related Products'); ?></h4>
                    <div id="mylist"></div>
                </div>
            </div>
        </div>
...
<?php $__env->startPush('script'); ?>
    ...
    <script>
        ...
        function fetch_data() {
            ...
            //console.info(ur);
            let url = `<?php echo e(route('user.giftcardbyid')); ?>?product=${productID}`;
        ...
        function relatedproducts(brand) {
            ...
            let url = `<?php echo e(route('user.fecthgiftcards')); ?>?productName=${brand ? brand : 'null'}`;
...
<?php echo $__env->make($activeTemplate . 'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ltecyxtc/public_html/core/resources/views/templates/basic/user/giftcard_auto/details.blade.php ENDPATH**/ ?>