    ...
    <div class="d-flex flex-lg-row-fluid">
        ...
        <div class="d-flex flex-column flex-center pb-0 pb-lg-10 p-10 w-100">
            ...
            <img class="theme-light-show mx-auto mw-100 w-150px w-lg-300px mb-10 mb-lg-20"
                src="<?php echo e(getImage('assets/images/frontend/emailauth/' . @$passwordContent->data_values->image, '630x540')); ?>"
                alt="" />
                    ...
                    <!--end::Icon-->
                        ...
                        <div class="text-center mb-11">
                            ...
                            <div class="text-gray-500 fw-semibold fs-6">
                                <p class="fw-bold text-start text-dark fs-6 mb-1 ms-1"><?php echo app('translator')->get('A 6 digit verification code sent to your email address'); ?> :<?php echo e(showEmailAddress(auth()->user()->email)); ?></p>
                            </div>
                            <!--end::Subtitle--->
                        </div>
                        <!--begin::Heading-->   
...
<?php echo $__env->make($activeTemplate . 'layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/billspaypoint/core/resources/views/templates/basic/user/auth/authorization/email.blade.php ENDPATH**/ ?>