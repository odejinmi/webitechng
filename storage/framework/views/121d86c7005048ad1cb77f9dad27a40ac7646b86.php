...
<!--end::User-->
        ...
        <?php endif; ?>
            ...
            <li class="nav-small-cap">
              <i class="ti ti-dots nav-small-cap-icon fs-4"></i>
              <span class="hide-menu"><?php echo app('translator')->get('LTechNg Trade'); ?></span>
            </li>
          ...
          <?php endif; ?>
            ...
            <li class="sidebar-item">
                <a class="sidebar-link" href="<?php echo e(route('user.virtualcard.index')); ?>" aria-expanded="false">
                  ...
                  <span class="hide-menu"><?php echo app('translator')->get('Virtual Card'); ?> <b>(Verve NGN)</b></span>
                </a>
            </li>
            <li class="sidebar-item">
                <a class="sidebar-link" href="<?php echo e(route('user.list.card')); ?>" aria-expanded="false">
                  <span>
                    <i class="ti ti-credit-card"></i>
                  </span>
                  <span class="hide-menu"><?php echo app('translator')->get('Virtual Card'); ?> <b>(Visa USD)</b></span>
                </a>
            </li>
            <?php endif; ?>
          ...
          <?php endif; ?>
            ...
            <span>
              <i class="ti ti-coin-bitcoin"></i>
                  ...
                  <li class="sidebar-item">
                      <a class="sidebar-link" href="<?php echo e(route('user.rnd.purchases.index')); ?>" aria-expanded="false">
            <span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="<?php echo e(route('user.utility.local.index')); ?>" aria-expanded="false">
                ...
                <span class="hide-menu"><?php echo app('translator')->get('Utility Bills'); ?> </span>
              </a>
            </li>
            <?php endif; ?>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="<?php echo e(route('user.education.index')); ?>" aria-expanded="false">
                <span class="d-flex">
                  <i class="ti ti-book"></i>
                </span>
                <span class="hide-menu"><?php echo app('translator')->get('Education '); ?></span>
              </a>
            </li>
            <?php endif; ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\PhpstormProjects\webitechng\resources\views/templates/basic/partials/sidenav.blade.php ENDPATH**/ ?>