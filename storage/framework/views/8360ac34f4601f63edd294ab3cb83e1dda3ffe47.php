                      ...
                      <div class="table-responsive">
                        ...
                        >
                          <thead>
                            <!-- start row -->
                            <tr>
                                <th><?php echo app('translator')->get('Product | Plan'); ?></th>
                                <th class="text-center"><?php echo app('translator')->get('Customer'); ?></th>
                                <th class="text-center"><?php echo app('translator')->get('Initiated'); ?></th>
                                <th class="text-center"><?php echo app('translator')->get('Beneficiary'); ?></th>
                                    ...
                                    <tr>
                                        <td>
                                            <span class="fw-bold"> 
                                              ...
                                              <span
                                                    class="text-primary"><?php echo e(__($deposit->product_name)); ?></span>
                                            </span>
                                            <br>
                                            <small> <?php echo e(__($deposit->val_2)); ?> </small>
                                            <br>
                                            <small> <?php echo e(__($deposit->deposit_code)); ?> </small>
                                        </td>
                                        <td class="text-center">
                                          <a href="<?php echo e(route('admin.users.detail', $deposit->user_id)); ?>">
                                          <div class="d-flex align-items-center">
                                            <img src="<?php echo e(getImage(getFilePath('userProfile') . '/' . $deposit->user->image, getFileSize('userProfile'))); ?>" alt="avatar" class="rounded-circle" width="35" />
                                            <div class="ms-3">
                                              <div class="user-meta-info">
                                                <h6 class="user-name mb-0" data-name="<?php echo e($deposit->user->fullname); ?>"> <?php echo e($deposit->user->fullname); ?></h6>
                                                <span class="user-work fs-3" data-occupation="<?php echo e($deposit->user->username); ?>"> <?php echo e($deposit->user->username); ?></span>
                                              </div>
                                            </div>
                                          </div>
                                          </a>
                                        ...
                                        <td class="text-center">
                                          <?php echo e(__($deposit->val_1)); ?>

                                            
                                        </td> 
                                        <td class="text-center">
                                           <small><?php echo e(__($general->cur_text)); ?> <?php echo e(showAmount($deposit->payment / $deposit->quantity)); ?></small>
                                            <br>
                                            <strong><?php echo e(showAmount($deposit->payment)); ?> <?php echo e(__($general->cur_text)); ?></strong>
                                        </td>
                                        <td class="text-center">
                                           <label class='badge <?php if($deposit->status == 'success'): ?> bg-success  <?php elseif($deposit->status == 'pending'): ?> bg-warning  <?php else: ?>  bg-danger <?php endif; ?>'> <?php echo $deposit->status ?></label>
                                        </td> 
                                    </tr>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ltecyxtc/public_html/core/resources/views/admin/bills/internet/internet_log.blade.php ENDPATH**/ ?>