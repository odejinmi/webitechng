                                                                            ...
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-body modal-body-md">
                                                                                    ...
                                                                                    <div class="nk-tnx-details">
                                                                                        <div
                                                                                            ...
                                                                                            <div class="nk-tnx-type">
                                                                                                <?php if($data->status == 1): ?>
                                                                                                    <div
                                                                                                        class="label bg-success text-success">
                                                                                                    <?php elseif($data->status == 0): ?>
                                                                                                        <div
                                                                                                            class="label bg-warning text-warning">
                                                                                                        <?php elseif($data->status == 2): ?>
                                                                                                            <div
                                                                                                                class="label bg-danger text-danger">
                                                                                                <?php endif; ?>
                                                                                        ...
                                                                                        <ul
                                                                                            ...
                                                                                            <li>
                                                                                                <?php if($data->status == 1): ?>
                                                                                                    <span
                                                                                                        class="badge badge-sm bg-success">Completed</span>
                                                                                                <?php elseif($data->status == 0): ?>
                                                                                                    <span
                                                                                                        class="badge badge-sm bg-warning">Pending</span>
                                                                                                <?php elseif($data->status == 2): ?>
                                                                                                    <span
                                                                                                        class="badge badge-sm bg-danger">Declined</span>
                                                                                                <?php endif; ?>
                                                                                            </li>
                                                                                        </ul>
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <h5 class="title">Transaction Info
                                                                                        </h5>
                                                                                    </div>
                                                                                    <div class="row gy-3">
...
<?php $__env->startPush('breadcrumb'); ?>
 <a class="btn bg-white text-primary" href="<?php echo e(route('user.tradegift')); ?>"> <i class="ti ti-printer"></i> <?php echo app('translator')->get('Back'); ?></a>
<?php $__env->stopPush(); ?>

<?php echo $__env->make($activeTemplate . 'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ltecyxtc/public_html/core/resources/views/templates/satoshi/user/giftcard/giftcard-log.blade.php ENDPATH**/ ?>