                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $gateways; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gateway): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <?php if($gateway->status == Status::DISABLE): ?>
                                                    <label class="label  bg-danger ms-1 text-white confirmationBtn"
                                                        <i class="la la-eye"></i> <?php echo app('translator')->get('Disabled'); ?>
                                                    </label>
                                         <?php else: ?>
                                                    <label class="label  bg-success  text-white ms-1 confirmationBtn"
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/billspaypoint/core/resources/views/admin/gateways/manual/list.blade.php ENDPATH**/ ?>