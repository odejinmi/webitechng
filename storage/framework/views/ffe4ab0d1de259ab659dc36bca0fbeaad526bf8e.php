    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        <div class="collapse navbar-collapse overflow-x-hidden" id="sidebarCollapse">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item my-1"><a class="nav-link d-flex align-items-center rounded-pill <?php echo e(Request::routeIs('user.buy.education') ? 'active' : ''); ?>"
                        href="<?php echo e(route('user.buy.education')); ?>" ><i class="bi bi-book"></i>
...
<?php /**PATH D:\PhpstormProjects\webitechng\resources\views/templates/satoshi/partials/sidenav.blade.php ENDPATH**/ ?>
