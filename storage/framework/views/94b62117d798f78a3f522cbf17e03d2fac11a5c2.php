                                            ...
                                            <script>
                                                function networkprovider(operatorId,image,name,networkid) { 
                                                          ...
                                                          document.getElementById("networkid").value = networkid;
                                                                  ...
                                                                  fetch("<?php echo e(route('user.internet_sme.operatorsInternetdetailsGTIDINGS')); ?>", requestOptions)
                                        ...
                                        function() {
                                            ...
                                            function submitform()
                                            {
                                              ...
                                              var raw = JSON.stringify({
                                                ...
                                                fetch("<?php echo e(route('user.buy.internet_sme_gtidings')); ?>", requestOptions)
                                                  .then(response => response.text())
                                                  .then(result => 
                                                  {
                                                    resp = JSON.parse(result);
...
<?php echo $__env->make($activeTemplate . 'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/billspaypoint/core/resources/views/templates/basic/user/bills/internetsme/internet_buy_GTIDINGS.blade.php ENDPATH**/ ?>