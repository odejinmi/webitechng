  ...
  <div class="d-flex flex-column flex-lg-row h-lg-100 gap-1">
    ...
    <!--  Scripts -->
     <div class="d-flex align-items-center gap-2 position-fixed bottom-0 end-0 mb-6 me-6 px-2 py-2 rounded-pill shadow-4 bg-white z-2">
        <img src="<?php echo e(getImage(getFilePath('logoIcon') . '/logo.png')); ?>" class="avatar avatar-xs">
...
<?php /**PATH C:\Users\DELL\PhpstormProjects\webitechng\resources\views/templates/satoshi/layouts/master.blade.php ENDPATH**/ ?>