    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="show-filter mb-3 text-end">
                <a class="btn btn-primary btn-sm" href="<?php echo e(route('user.bank.transfer.start')); ?>"><i class="ti ti-send"></i>
                    <?php echo app('translator')->get('Transfer Money'); ?></a>
            </div>
                        ...
                        <table id="file_export" class="table border table-striped table-bordered display text-nowrap">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th><?php echo app('translator')->get('Narration'); ?></th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="break_line">
                                        <?php echo app('translator')->get('Bank Name '); ?>:<?php echo e(@$trx->val_1->bank); ?><br>
                                        <?php echo app('translator')->get('Account Name '); ?>:<?php echo e(@$trx->val_1->account_name); ?><br>
                                        <?php echo app('translator')->get('Account Number '); ?>:<?php echo e(@$trx->val_1->account_number); ?><br>
                                    </td>
                                </tr>
...
<?php echo $__env->make($activeTemplate . 'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ltecyxtc/public_html/core/resources/views/templates/basic/user/bank/history.blade.php ENDPATH**/ ?>