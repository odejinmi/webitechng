<?php $__env->startSection('panel'); ?>
            ...
            <div class="modal-dialog modal-dialog-scrollable modal-lg">
                <div class="modal-content">
                    <div class="modal-body">
                        ...
                        <form class="ps-3 pr-3" action="<?php echo e(route('user.crypto.buy.confirm.manual')); ?>" method="POST"
    ...
    <?php $__env->startPush('breadcrumb'); ?>
        <a class="btn btn-sm btn-primary" href="<?php echo e(route('user.crypto.buy.log')); ?>"> <i class="ti ti-printer"></i>
            <?php echo app('translator')->get('Trade Log'); ?></a>
    <?php $__env->stopPush(); ?>

<?php echo $__env->make($activeTemplate . 'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DELL\PhpstormProjects\webitechng\resources\views/templates/satoshi/user/assets/crypto/buycrypto/buy.blade.php ENDPATH**/ ?>