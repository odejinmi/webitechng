						...
						<div class="col-xl-10 offset-xl-1">
							<div class="service-txt mt-30">
								...
								<ul class="simple-list">
									...
									<li class="list-item">
										<p class="p-md">We are reliable. Of course we know how hectic life can be but managing your crypto should not be. We operate a 100% uptime system. <?php echo e($general->site_name); ?> is always operational and available to serve you because you come first
										</p>
									</li>
...
<?php echo $__env->make($activeTemplate . 'layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/itechng/core/resources/views/templates/basic/assets.blade.php ENDPATH**/ ?>