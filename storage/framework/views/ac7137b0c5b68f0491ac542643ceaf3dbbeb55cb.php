<?php $__env->startSection('panel'); ?>
    <div class="row">
        <div class="col-md-12 mb-30">
            <div class="card">
                <div class="card-body">
                    <form action="<?php echo e(route('admin.frontend.sections.content', $key)); ?>" class="" method="POST"
                                                    ...
                                                    <div class="thumb">
                                                                    ...
                                                                    <div class="card">
                                                                        <div class="card-body">
                                                                            ...
                                                                            <div class="text-center">
                                                                                <img src="<?php echo e(getImage('assets/images/frontend/' . $key . '/' . @$data->data_values->$imgKey, @$section->element->images->$imgKey->size)); ?>"
                                                        ...
                                                        <div class="avatar-edit">
                                                            ...
                                                            <small class="mt-2  "><?php echo app('translator')->get('Supported files'); ?>: <b><?php echo app('translator')->get('jpeg'); ?>,
                                                                    <?php echo app('translator')->get('jpg'); ?>, <?php echo app('translator')->get('png'); ?></b>.
                                                ...
                                                <select class="form-control" name="<?php echo e(@$selectName); ?>" required>
                                                    <?php $__currentLoopData = $content->options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $selectItemKey => $selectOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($selectItemKey); ?>"
                                                            <?php if(@$data->data_values->$selectName == $selectItemKey): ?> selected <?php endif; ?>>
                                                            <?php echo e(__($selectOption)); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control" name="<?php echo e($k); ?>"
                                                    value="<?php echo e(@$data->data_values->$k); ?>" required />
                                            </div>
                                        </div>
                                    <?php endif; ?>
                                <?php endif; ?>
...
<?php $__env->startPush('style-lib'); ?>
    <link href="<?php echo e(asset('assets/thirdparty/css/fontawesome-iconpicker.min.css')); ?>" rel="stylesheet">
<?php $__env->stopPush(); ?>

<?php $__env->startPush('script-lib'); ?>
    <script src="<?php echo e(asset('assets/thirdparty/js/fontawesome-iconpicker.js')); ?>"></script>
<?php $__env->stopPush(); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ltecyxtc/public_html/core/resources/views/admin/frontend/element.blade.php ENDPATH**/ ?>