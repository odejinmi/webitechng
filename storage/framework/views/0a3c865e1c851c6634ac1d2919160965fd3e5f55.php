                ...
                <div class="d-flex flex-center flex-column flex-column-fluid pb-15 pb-lg-20">
                    ...
                    <div class="text-center mb-10">
                        ...
                        <div class="text-gray-500 text-center fw-semibold fs-6">
                            <?php echo app('translator')->get('Have an account'); ?>

                            <a href="<?php echo e(route('user.login')); ?>" class="link-primary">
...
<?php echo $__env->make($activeTemplate . 'layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/billspaypoint/core/resources/views/templates/basic/user/auth/passwords/email.blade.php ENDPATH**/ ?>