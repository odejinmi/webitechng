                ...
                <div class="card-body">
                    ...
                    <form class="form" id="kt_file_manager_settings">
                        ...
                        <div class="fv-row row mb-15">
                            ...
                            <div class="col-md-3">
                                <!--begin::Label-->
                                <label class="fs-6 fw-semibold "><?php echo app('translator')->get('Transaction Password'); ?></label>
                                <!--end::Label-->
                            </div>
                            <!--end::Col-->
...
<?php echo $__env->make($activeTemplate . 'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/billspaypoint/core/resources/views/templates/basic/user/bills/airtime/airtime_buy_local.blade.php ENDPATH**/ ?>