            ...
            <div class="card">
                <form action="<?php echo e(route('admin.gateway.automatic.update', $gateway->code)); ?>" method="POST"
                    ...
                    <div class="card-body">
                        <div class="payment-method-item block-item">
                            <div class="payment-method-header">
                                <img width="40" src="<?php echo e(getImage(imagePath()['gateway']['path'].'/'. $gateway->image,imagePath()['gateway']['size'])); ?>" alt="" class="img-fluid ms-auto"> 
                                    ...
                                    <?php if(count($supportedCurrencies) > 0): ?>
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <div class="input-group d-flex flex-wrap justify-content-end width-375">
                                                <select class="newCurrencyVal form-control-lg select2">
                                                ...
                                                <button type="button"
                                                    class="btn btn-outline-primary btn-sm input-group-text newCurrencyBtn"
                                                    data-crypto="<?php echo e($gateway->crypto); ?>"
                                                    data-name="<?php echo e($gateway->name); ?>"><?php echo app('translator')->get('Add new'); ?></button>
                                            </div>
                                        </div>
                                    <?php endif; ?>
                                            ...
                                            <div class="form-group col-lg-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <button type="button" class="copyInput input-group-text"
                                                        title="<?php echo app('translator')->get('Copy'); ?>"><i class="fa fa-copy"></i></button>
                                                </div>
                                ...
                                <div class="payment-method-item block-item child--item">
                                            ...
                                            <div class="d-flex justify-content-between">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        ...
                                                        value="<?php echo e($gatewayCurrency->name); ?>" required placeholder="Gateway Name" />
                                                </div>
                                                <div class="remove-btn">
                                                    <button type="button" class="btn btn-danger confirmationBtn"
                                                        data-question="<?php echo app('translator')->get('Are you sure to delete this gateway currency?'); ?>"
                                                        data-action="<?php echo e(route('admin.gateway.automatic.remove', $gatewayCurrency->id)); ?>">
                                                        <i class="ti ti-trash me-2"></i><?php echo app('translator')->get('Remove'); ?>
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="payment-method-body">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4">
                                                <div class="card border-primary mt-2">
                                                    <h5 class="card-header bg-light-primary"><?php echo app('translator')->get('Currency'); ?></h5>
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group mb-3">
                                            ...
                                            <?php if($parameters->where('global', false)->count() != 0): ?>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="card border-primary mt-4">
                                                        <h5 class="card-header bg-light-primary"><?php echo app('translator')->get('Configuration'); ?></h5>
                                                        <div class="card-body">
                                                            <div class="row">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <div class="form-group">
                                            ...
                                            <input disabled type="text" class="form-control"
                                                name="currency[<?php echo e($currencyIndex); ?>][name]" required placeholder="Gateway Name"/>
                                        </div>
                                        <div class="remove-btn">
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-outline-primary h-45">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ltecyxtc/public_html/core/resources/views/admin/gateways/automatic/edit.blade.php ENDPATH**/ ?>