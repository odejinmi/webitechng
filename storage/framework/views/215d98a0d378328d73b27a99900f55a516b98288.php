<?php $__env->startSection('panel'); ?>
    <div class="row">
        <div class="col-lg-12 col-md-12 mb-30">
            <div class="card">
                <div class="card-body">
                    <form action="<?php echo e(route('admin.frontend.sections.content', 'seo')); ?>" method="POST"
                        ...
                        <div class="row">
                                    ...
                                    <div class="image-upload">
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <div class="text-center">
                                                        <img src="<?php echo e(getImage(getFilePath('seo') . '/' . @$seo->data_values->image, getFileSize('seo'))); ?>"
                                        ...
                                        <div class="thumb">
                                            ...
                                            <div class="avatar-edit">
                                                <input type="file" class="form-control profilePicUpload" name="image_input"
                                                ...
                                                <small class="mt-2"><?php echo app('translator')->get('Supported files'); ?>: <b><?php echo app('translator')->get('jpeg'); ?>,
                                                    ...
                                                    <?php echo e(getFileSize('seo')); ?><?php echo app('translator')->get('px'); ?>. </small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-8 mt-xl-0 mt-4">
                                <div class="form-group ">
                                    ...
                                    <small class="ms-2 mt-2  "><?php echo app('translator')->get('Separate multiple keywords by'); ?> <code>,</code>(<?php echo app('translator')->get('comma'); ?>)
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="social_title"
                                        value="<?php echo e(@$seo->data_values->social_title); ?>" required />
                                </div>
                                <div class="form-group mb-3">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ltecyxtc/public_html/core/resources/views/admin/frontend/seo.blade.php ENDPATH**/ ?>