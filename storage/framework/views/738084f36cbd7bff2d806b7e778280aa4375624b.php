<?php $__env->startSection('panel'); ?>
            ...
            <div class="card">
                ...
                <div class="card-body">
                        ...
                        <div class="notice d-flex bg-light-warning rounded border-warning border border-dashed  p-6">
                            ...
                            <div class="d-flex flex-stack flex-grow-1 ">
                                ...
                                <div class=" fw-semibold">
                                    <h4 class="text-gray-900 fw-bold"><?php echo app('translator')->get('Create Voucher'); ?></h4>

                                    <div class="fs-6 text-gray-700 "><?php echo app('translator')->get('Welcome to our voucher generation portal where you can generate and redeem voucher code from users on the platform<br>
                                   <b> You can click on the voucher log button at the top right corner of your screen to view your voucher log</b>
                                    '); ?>
                                        ...
                                        <a href="#"  data-bs-toggle="modal" data-bs-target="#redeem-modal"  class="btn btn-success er fs-6 px-8 py-4">
                                            <?php echo app('translator')->get('Redeem Voucher'); ?> </a>
                                        <br> <br>
                                        <!--end::Action-->
                                    </div>
                                </div>
                    ...
                    <div class="text-center pb-15 px-5">
                        <img src="<?php echo e(asset('assets/assets/dist/images/backgrounds/voucher.jpeg')); ?>" alt="" class="mw-100 h-200px h-sm-325px" />
                    </div>
                    <!--end::Illustration-->
                </div>
                <!--end::Card body-->
    ...
    <?php $__env->startPush('breadcrumb-plugins'); ?>
        <a class="btn btn-sm btn-primary" href="<?php echo e(route('user.voucher.history')); ?>"> <i class="ti ti-printer"></i> <?php echo app('translator')->get('My Voucher'); ?></a>
    <?php $__env->stopPush(); ?>
    <?php $__env->startPush('script'); ?>
    <?php $__env->stopPush(); ?>

<?php echo $__env->make($activeTemplate . 'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/billspaypoint/core/resources/views/templates/basic/user/vendor/voucher/index.blade.php ENDPATH**/ ?>