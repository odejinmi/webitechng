                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-sm btn-outline-primary notifyDetail"
                                                data-type="<?php echo e($log->notification_type); ?>"
                                                <?php if($log->notification_type == 'email'): ?> data-message="<?php echo e(route('admin.report.email.details', $log->id)); ?>" <?php else: ?> data-message="<?php echo e($log->message); ?>" <?php endif; ?>
                                                data-sent_to="<?php echo e($log->sent_to); ?>" target="_blank"><i
                                                    class="las la-desktop"></i> <?php echo app('translator')->get('Detail'); ?></button>
                                        </td>
                                    </tr>
...
<?php $__env->startPush('breadcrumb-plugins'); ?>
    ...
    <?php if(@$user): ?>
        <a href="<?php echo e(route('admin.users.notification.single', $user->id)); ?>" class="btn btn-outline--primary btn-sm"><i
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ltecyxtc/public_html/core/resources/views/admin/reports/notification_history.blade.php ENDPATH**/ ?>