                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="<?php echo e(route('admin.language.key', $item->id)); ?>"
                                                    ...
                                                    <i class="ti ti-code"></i> <?php echo app('translator')->get('Translate'); ?>
                                                </a>
                                                <a href="javascript:void(0)"
                                                    ...
                                                    <i class="ti ti-pen"></i> <?php echo app('translator')->get('Edit'); ?>
                                                </a>
                                                <?php if($item->id != 1): ?>
                                                    <button class="btn btn-sm btn-outline-danger confirmationBtn"
                                                        ...
                                                        <i class="ti ti-trash"></i> <?php echo app('translator')->get('Remove'); ?>
                                                    </button>
                                                <?php endif; ?>
                                            </div>
                                        </td>
            ...
            <div class="modal-content">
                ...
                <form class="form-horizontal" method="post" action="<?php echo e(route('admin.language.manage.store')); ?>">
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-outline-primary w-100 h-45" id="btn-save"
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ltecyxtc/public_html/core/resources/views/admin/language/lang.blade.php ENDPATH**/ ?>