<?php $__env->startSection('panel'); ?>
    ...
    <form action="<?php echo e(route('user.change.password')); ?>" class="form" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
    ...
    <form action="<?php echo e(route('user.change.trxpassword')); ?>" class="form" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div class="" id="id4" role="tabpanel">
            <div class="row g-6 align-items-end justify-content-between">
                <div class="col">
...
<?php echo $__env->make($activeTemplate . 'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DELL\PhpstormProjects\webitechng\resources\views/templates/satoshi/user/security_setting.blade.php ENDPATH**/ ?>