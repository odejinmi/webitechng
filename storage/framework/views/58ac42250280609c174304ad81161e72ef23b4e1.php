                      ...
                      <div class="table-responsive">
                        ...
                        >
                          <thead>
                            <!-- start row -->
                            <tr>
                                <th><?php echo app('translator')->get('Event'); ?></th>
                          ...
                          <tbody>
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = @$log; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deposit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                           <label class='badge <?php if($deposit->status == 'success'): ?> bg-success  <?php elseif($deposit->status == 'PENDING'): ?> bg-warning  <?php else: ?>  bg-danger <?php endif; ?> text-white'> <?php echo $deposit->status ?></label>
                                           
                                        </td> 
                                        <td class="text-center">
                                           <?php if($deposit->status == 'success'): ?><br>
                                           <a href="<?php echo e(route('user.event.tickets',$deposit->trx)); ?>" class="btn btn-sm btn-primary">View Tickets</a>
                                           <?php endif; ?>
                                        </td> 
                                    </tr>
...
<?php echo $__env->make($activeTemplate . 'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/billspaypoint/core/resources/views/templates/basic/user/bills/event/event_log.blade.php ENDPATH**/ ?>