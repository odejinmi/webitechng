        ...
        <div class="px-3s px-md-8s pt-8s">
            ...
            <div class="row row-cols-xl-4 row-cols-md-2 g-6 mt-6">
                ...
                <?php $__currentLoopData = $networks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $network): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col">
                        <div class="<?php echo e($network["class"]); ?>">
                            <div class="p-5">
                                <div class="d-flex gap-3 mb-5"><img src="<?php echo e(url('/')); ?>/assets/images/provider/<?php echo e($network["logo"]); ?>" class="avatar"
                                                                    alt="...">
                                    <div class=""><a class="d-inline-block text-sm text-heading fw-semibold"
                                                     href="#"><?php echo e($network["name"]); ?>

                                        </a><span class="d-block text-xs text-muted"><?php echo e($network["description"]); ?></span></div>
                                </div>
        ...
        <div class="border-top">
            <div class="table-responsive">
                <table class="table table-hover table-striped table-nowrap">
                    ...
                    <tbody>
                      <?php $__empty_1 = true; $__currentLoopData = $educationlog; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td>
    ...
    <div class="modal fade" id="topUpModal" tabindex="-1" aria-labelledby="topUpModalLabel"
                                                ...
                                                <button class="btn btn-sm btn-neutral rounded-pill shadow-none flex-none d-flex align-items-center gap-2 p-2" data-bs-toggle="dropdown" aria-expanded="false">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-sm">
                                                      <?php $__currentLoopData = ($networks); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <li onclick="verifynetwork(`<?php echo e($plan['logo']); ?>`,`<?php echo e($plan['serviceID']); ?>`)"><a class="dropdown-item d-flex align-items-center gap-2" href="#"><img src="<?php echo e(url('/')); ?>/assets/images/provider/<?php echo e($plan['logo']); ?>" class="w-rem-6 h-rem-6 rounded-circle" alt="...">
                                                          ...
                                                          <script>
                                                            ...
                                                            function getplans(logo,decoder) {
                                                              var raw = JSON.stringify({
                                                                ...
                                                                const url = `<?php echo e(route('user.education.operators')); ?>?decoder=${encodeURIComponent(decoder)}&_token=${csrfToken}`;
                                                              var requestOptions = {
                                                                method: 'GET',
                                                                headers: {
                        ...
                        <input id="customername" hidden>
                                            ...
                                            function validatedecoder() {
                                                ...
                                                $.ajax({
                                                    url: "<?php echo e(route('user.education.verifydecoder')); ?>",
                                                    type: 'GET',
                                                    async: true,
                                                    data: {
                                                    _token: _token,
...
<?php $__env->startPush('script'); ?>
    <script>
        function submitform() {
            ...
            fetch("<?php echo e(route('user.buy.education')); ?>", requestOptions).then(response => response.text()).then(
                result => {
...
<?php echo $__env->make($activeTemplate . 'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PhpstormProjects\webitechng\resources\views/templates/satoshi/user/bills/education/education_buy.blade.php ENDPATH**/ ?>