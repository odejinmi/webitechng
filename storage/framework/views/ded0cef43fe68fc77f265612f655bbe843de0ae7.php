                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if($extension->status == Status::DISABLE): ?>
                                                   <span type="button" class="badge bg-danger mb-2"> <?php echo app('translator')->get('Disable'); ?> </span>
                                                <?php else: ?>
                                                    <span type="button" class="badge bg-success mb-2"> <?php echo app('translator')->get('Disable'); ?> </span>
                                                <?php endif; ?>
                                        </td>
                                        <td>
            ...
            <div class="modal-content">
                ...
                <form method="POST">
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-outline-primary w-100 h-45"
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ltecyxtc/public_html/core/resources/views/admin/extension/index.blade.php ENDPATH**/ ?>