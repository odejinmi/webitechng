                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="user_id" name="user_id" required>
                                                ...
                                                <option value="<?php echo e($user->id); ?>"><?php echo e($user->name ?? $user->email); ?> (<?php echo e($user->email); ?>)</option>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="<?php echo e($user->id); ?>" id="user_<?php echo e($user->id); ?>" name="user_ids[]">
                        ...
                        <div class="tab-pane fade" id="all-users" role="tabpanel">
                            <form id="allUsersForm" class="mt-3">
                                <div class="alert alert-info">
                                    <i class="fas fa-info-circle"></i> This will send notification to all users with FCM tokens (<?php echo e($users->count()); ?> users)
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PhpstormProjects\webitechng\resources\views/admin/notifications/index.blade.php ENDPATH**/ ?>