        ...
        <div class="container">
            ...
            <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                <br>
					<div class="data-details-head">Front View</div>
					<div class="data-doc-item data-doc-item-lg">
					    <?php if($exchange->source == 'mobile'): ?>
						<div class="data-doc-image"><img width="40" src="https://mobile.ltechng.co/assets/images/giftcards/<?php echo e($exchange->image); ?>"
								alt="passport">
						<?php else: ?>
						<div class="data-doc-image"><img width="40" src="<?php echo e(asset('assets/images/giftcards/' . $exchange->image)); ?>"
								alt="passport">
						...
						<ul class="data-doc-actions">
							<li>
							     <?php if($exchange->source == 'mobile'): ?>
							    <a href="https://mobile.ltechng.co/assets/images/giftcards/<?php echo e($exchange->image); ?>" download><i
										class="fa fa-download"></i></a>
								<?php else: ?>
							    <a href="<?php echo e(asset('assets/images/giftcards/' . $exchange->image)); ?>" download><i
										class="fa fa-download"></i></a>
            ...
            <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                <br>
					...
					<div class="data-doc-item data-doc-item-lg">
					    <?php if($exchange->source == 'mobile'): ?>
						<div class="data-doc-image"><img width="40" src="https://mobile.ltechng.co/assets/images/giftcards/<?php echo e($exchange->image2); ?>"
								alt="passport">
						<?php else: ?>
						...
						<ul class="data-doc-actions">
							<li>
							     <?php if($exchange->source == 'mobile'): ?>
							    <a href="https://mobile.ltechng.co/assets/images/giftcards/<?php echo e($exchange->image2); ?>" download><i
										class="fa fa-download"></i></a>
								<?php else: ?>
							    <a href="<?php echo e(asset('assets/images/giftcards/' . $exchange->image2)); ?>" download><i
										class="fa fa-download"></i></a>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ltecyxtc/public_html/core/resources/views/admin/giftcard/giftcard-info.blade.php ENDPATH**/ ?>