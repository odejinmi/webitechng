...
<?php endif; ?>
            <a href="<?php echo e(route('user.airtime.tocash.request')); ?>" class="btn btn-primary">
                <i class="ti ti-plus"></i>
                <?php echo app('translator')->get('New Request'); ?>
            </a>
        <?php $__env->stopPush(); ?>
...
<?php echo $__env->make($activeTemplate . 'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/billspaypoint/core/resources/views/templates/basic/user/bills/airtime2cash/history.blade.php ENDPATH**/ ?>