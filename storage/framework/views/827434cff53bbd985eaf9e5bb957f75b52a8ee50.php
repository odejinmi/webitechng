                      ...
                      <div class="table-responsive">
                        ...
                        >
                          <thead>
                            <!-- start row -->
                            <tr>
                                <th><?php echo app('translator')->get('Insurance | Plan'); ?></th>
                          ...
                          <tbody>
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = @$log; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deposit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td>
                                            <span class="fw-bold"> 
                                              <span class="text-primary"><?php echo e(__($deposit->product_name)); ?></span>
                                            </span>
                                            <br>
                                        ...
                                        <td>
                                          ...
                                          <span class="fw-bold"> 
                                            <span class="text-primary"><?php echo e(__(@$deposit->user->username)); ?></span>
                                          </span> 
                                          </a>
                                      </td>
                                        ...
                                        <td class="text-center">
                                          <?php echo $deposit->val_3; ?>

                                          <?php if($deposit->deposit_code == 'motor'): ?>
                                          <br>
                                          <a href="<?php echo e(__($deposit->val_2)); ?>" class="btn btn-sm btn-primary">Download Certificate</a>
                                          <?php endif; ?>
                                        </td> 
                                        <td class="text-center">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ltecyxtc/public_html/core/resources/views/admin/bills/insurance/insurance_log.blade.php ENDPATH**/ ?>