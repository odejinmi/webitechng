      ...
      <div class="col-sm-6 col-xl-6">
        <div class="card bg-light-info shadow-none">
          <div class="card-body p-4">
            ...
            <?php $hasPermission = App\Models\Role::hasPermission(['admin.crypto.viewwallet*'])  ? 1 : 0;
            if($hasPermission == 1): ?>
            <div class="d-flex align-items-center justify-content-between mt-4">
              <a href="<?php echo e(route('admin.crypto.viewwallet',encrypt($data->id))); ?>" class="btn btn-sm btn-primary"><?php echo app('translator')->get('View Wallet'); ?></a>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/billspaypoint/core/resources/views/admin/currency/wallet/index.blade.php ENDPATH**/ ?>