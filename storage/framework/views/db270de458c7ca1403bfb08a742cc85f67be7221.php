...
<head>
    ...
    <link href="<?php echo e(asset($activeTemplateTrue . 'css/styles.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('assets/thirdparty/css/cookie.css')); ?>" rel="stylesheet" type="text/css"/>
...
<body> 
    ...
    <div class='ckWrap ' id='ckBox'>
        <div class='ckCont'>
          ...
          <p><?php echo e($cookie->data_values->short_desc); ?></p>
        </div>
        <a href="<?php echo e(route('cookie.accept')); ?>" class='btn' id='ckAcptBtn'><?php echo app('translator')->get('Accept Cookies!'); ?></a>
        <a class='btn outl' href='<?php echo e(route('cookie.policy')); ?>'><?php echo app('translator')->get('Learn More'); ?></a>
      </div>
    <?php endif; ?>
		...
		<script src="<?php echo e(asset($activeTemplateTrue . 'js/bootstrap-select.min.js')); ?>"></script>
		<script src="<?php echo e(asset($activeTemplateTrue . 'js/rangeslider.js')); ?>"></script>
		<script src="<?php echo e(asset($activeTemplateTrue . 'js/slick.js')); ?>"></script>
		<script src="<?php echo e(asset($activeTemplateTrue . 'js/counterup.min.js')); ?>"></script>
		<script src="<?php echo e(asset($activeTemplateTrue . 'js/jquery.magnific-popup.min.js')); ?>"></script>
		<script src="<?php echo e(asset($activeTemplateTrue . 'js/imagesloaded.pkgd.min.js')); ?>"></script>
		<script src="<?php echo e(asset($activeTemplateTrue . 'js/shuffle.min.js')); ?>"></script>
		<script src="<?php echo e(asset($activeTemplateTrue . 'js/wow.js')); ?>"></script>
		<script src="<?php echo e(asset($activeTemplateTrue . 'js/lunar.js')); ?>"></script>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/billspaypoint/core/resources/views/templates/basic/layouts/frontend.blade.php ENDPATH**/ ?>