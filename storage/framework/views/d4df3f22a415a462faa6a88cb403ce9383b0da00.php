        ...
        <div class="border-top">
            <div class="table-responsive">
                <table class="table table-hover table-striped table-nowrap">
                    ...
                    <tbody>
                      <?php $__empty_1 = true; $__currentLoopData = $airtimelog; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td>
                                <div class="d-flex align-items-center gap-3">
                                    <img src="<?php echo e(url('/')); ?>/assets/images/provider/<?php echo e($data->product_name); ?>.jpeg"
                                    ...
                                    <form class="vstack gap-8">
                                                ...
                                                <button class="btn btn-sm btn-neutral rounded-pill shadow-none flex-none d-flex align-items-center gap-2 p-2" data-bs-toggle="dropdown" aria-expanded="false">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-sm">
                                                      <?php $__currentLoopData = json_decode($networks); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <li onclick="verifynetwork(`<?php echo e($plan->logo); ?>`,`<?php echo e($plan->networkid); ?>`)"><a class="dropdown-item d-flex align-items-center gap-2" href="#"><img src="<?php echo e(url('/')); ?>/assets/images/provider/<?php echo e($plan->logo); ?>" class="w-rem-6 h-rem-6 rounded-circle" alt="...">
                                        ...
                                        <div class="bg-body-secondary rounded-3 p-4">
                                            ...
                                            <div class="d-flex justify-content-between gap-2 mt-4"><input type="tel" id="amount" class="form-control form-control-flush text-xl fw-bold flex-fill" placeholder="0.00">
                                                <button class="btn btn-neutral shadow-none rounded-pill flex-none d-flex align-items-center gap-2 py-2 ps-2 pe-4"><img src="<?php echo e(url('/')); ?>/assets/images/country/ngn.png" class="w-rem-6 h-rem-6 rounded-circle" alt="..."> <span class="text-xs fw-semibold text-heading ms-1">NGN</span></button>
                                            </div>
                                        </div>
...
<?php $__env->startPush('script'); ?>
    <script>
        function submitform() {
            ...
            fetch("<?php echo e(route('user.buy.airtime.local.post')); ?>", requestOptions).then(response => response.text()).then(
                result => {
...
<?php echo $__env->make($activeTemplate . 'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ltecyxtc/public_html/core/resources/views/templates/satoshi/user/bills/airtime/airtime_buy.blade.php ENDPATH**/ ?>