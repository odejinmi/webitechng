                        ...
                        <table class="table table--light style--two custom-data-table">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $gateways->sortBy('alias'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$gateway): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td><?php echo e(__($gateway->name)); ?><br>
                                        ...
                                        <?php if($gateway->status == Status::DISABLE): ?>
                                                    <label class="badge  bg-danger ms-1 text-white confirmationBtn"
                                                        <i class="la la-eye"></i> <?php echo app('translator')->get('Disabled'); ?>
                                                    </label>
                                         <?php else: ?>
                                                    <label class="badge  bg-success  text-white ms-1 confirmationBtn"
                                                        <i class="la la-eye-slash"></i> <?php echo app('translator')->get('Enabled'); ?>
                                                    </label>
                                        <?php endif; ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ltecyxtc/public_html/core/resources/views/admin/gateways/automatic/list.blade.php ENDPATH**/ ?>