                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <select name="country" class="form-select form-select-solid"
                                                ...
                                                <?php $__currentLoopData = $networks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option data-decoder="<?php echo e($data['serviceID']); ?>">
                                        ...
                                        <?php $__env->startPush('script'); ?>
                                            <script>
                                                ...
                                                `;
                                                    ...
                                                    $.ajax({
                                                        url: "<?php echo e(route('user.education.operators')); ?>",
                                                        type: 'GET',
                                                        async: true,
                                                        data:
                                                        {
                                ...
                                <div data-kt-stepper-element="content">
                                    ...
                                    <div class="w-100">
                                        ...
                                        <div class="fv-row mb-10">
                                            <!--begin::Label-->
                                            <label class="form-label required"><?php echo app('translator')->get('Enter '); ?> <a id="serviceprovider"></a> <?php echo app('translator')->get('Phone Number'); ?></label>
                                            <!--end::Label-->

                                            <!--begin::Input-->
                                            <input name="decoder" id="decoder"  class="form-control form-control-lg form-control-solid"/>
                                            <div id="profilecodediv" hidden>
                                            <label class="form-label required"><?php echo app('translator')->get('Enter '); ?> <a id="profilecode"></a> <?php echo app('translator')->get('Profilecode'); ?></label>
                                            <!--end::Label-->
                                        ...
                                        <script>
                                            ...
                                            var decoder = document.getElementById("profilecode").value;
                                            $("#returnreply").html('');
                                            var _token = $("input[name='_token']").val();
                                            document.getElementById("customer").innerHTML = '';
                                                    $.ajax({
                                        ...
                                        <div class="pb-8 pb-lg-10">
                                            ...
                                            <section class="payment-method text-center">
                                              ...
                                              <div class="d-sm-flex align-items-center justify-content-between my-4">
                                               <center>  <a href="<?php echo e(route('user.education.history')); ?>" class="btn btn-primary d-block"><?php echo app('translator')->get('View Order'); ?></a> </center>
                                              </div>
                                            </section>
                                        </div>
                                    </div>
...
<?php echo $__env->make($activeTemplate . 'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PhpstormProjects\webitechng\resources\views/templates/basic/user/bills/education/education_buy.blade.php ENDPATH**/ ?>