                    ...
                    <div class="card bg-success bg-opacity-10 border-success border-opacity-40">
                        <div class="p-5">
                            ...
                            <div class="d-flex align-items-end">
                                <div class="hstack gap-2">
                                    <span
                                        class="badge bg-success bg-opacity-25 text-success"><?php echo e(number_format($count)); ?></span>
        ...
        <div class="border-top">
            <div class="table-responsive">
                <table class="table table-hover table-striped table-nowrap">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $bettinglog; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td>
                            ...
                            <div class="d-flex justify-content-between gap-2 mt-4">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-sm">
                                    <?php $__currentLoopData = $networks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li onclick="verifynetwork(`<?php echo e($plan['title']); ?>`,`<?php echo e($plan['providerLogoUrl']); ?>`)"><a
                                                class="dropdown-item d-flex align-items-center gap-2" href="#">
                                                <img src="<?php echo e($plan['providerLogoUrl']); ?>"
                                                    class="w-rem-6 h-rem-6 rounded-circle" alt="...">
                                                <span><?php echo e(strToUpper($plan['title'])); ?></span>
                                            </a>
                                        </li>
...
<?php $__env->startPush('script'); ?>
    <script>
        function submitform() {
            ...
            fetch("<?php echo e(route('user.fund.betting.wallet')); ?>", requestOptions).then(response => response.text()).then(
                result => {
...
<?php echo $__env->make($activeTemplate . 'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ltecyxtc/public_html/core/resources/views/templates/satoshi/user/bills/betting/betting_buy.blade.php ENDPATH**/ ?>