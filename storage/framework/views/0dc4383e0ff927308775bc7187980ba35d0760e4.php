                            ...
                            <form class="card-body py-20 w-100 mw-xl-700px px-9" novalidate="novalidate"
                                ...
                                <div data-kt-stepper-element="content">
                                    ...
                                    <div class="w-100">
                                        ...
                                        <div class="pb-10 pb-lg-15">
                                            <!--begin::Title-->
                                            <h2 class="fw-bold text-dark"><?php echo app('translator')->get('Select Provider'); ?></h2>
                                            <!--end::Title-->

                                            <!--begin::Notice-->
                                            <div class="text-muted fw-semibold fs-6">
                                               <?php echo app('translator')->get('Please select your prefered service provider below'); ?>.
                                            </div>
                                            <!--end::Notice-->
                                        </div>
                                        <!--end::Heading-->
                                        ...
                                        <div class="mb-10 fv-row">
                                            <!--begin::Label-->
                                            <label class="form-label mb-3"><?php echo app('translator')->get('Select Company'); ?></label>
                                            <!--end::Label-->
                                            ...
                                            <label class="d-flex flex-stack cursor-pointer mb-5" for="<?php echo e(strToUpper($data['provider'])); ?>" >
                                                <span class="d-flex align-items-center me-2">
                                                    <span class="symbol symbol-50px me-6">
                                                        <span class="symbol-label bg-light-primary">
                                                            <i class="ti ti-image fs-2x text-warning"><img src="<?php echo e($data['providerLogoUrl']); ?>" width="30" class="path1"/></i>
                                                        </span>
                                                    </span> 
                                                    <span class="d-flex flex-column">
                                                        <span class="fw-bold fs-6"><?php echo e(strToUpper($data['provider'])); ?></span>
                                                        <span class="fs-7 text-muted"><?php echo e($general->cur_sym); ?> <?php echo e(@number_format($data['minAmount']['amount'],2)); ?> - <?php echo e($general->cur_sym); ?><?php echo e(@number_format($data['maxAmount']['amount'],2)); ?></span>
                                                    </span>
                                                </span>
                                                <span class="form-check form-check-custom form-check-solid">
                                                    <input class="form-check-input" type="radio" name="provider" id="<?php echo e(strToUpper($data['provider'])); ?>"  onchange="networkprovider('<?php echo e(strToUpper($data['provider'])); ?>')" value="<?php echo e(strToUpper($data['provider'])); ?>" />
                                                </span>
                                            </label>
                                ...
                                <div data-kt-stepper-element="content">
                                    ...
                                    <div class="w-100">
                                        ...
                                        <div class="pb-10 pb-lg-12">
                                            ...
                                            <!--begin::Notice-->
                                            <div class="text-muted fw-semibold fs-6">
                                                <?php echo app('translator')->get('Please enter beneficiary\'s wallet ID and amount below'); ?></a>.
                                            </div>
                                            <!--end::Notice-->
                                        </div>
                                        <!--end::Heading-->
                                        ...
                                        <div class="fv-row mb-10">
                                            <!--begin::Label-->
                                            <label class="form-label required"><?php echo app('translator')->get('Enter '); ?> <a id="serviceprovider"></a> <?php echo app('translator')->get('Wallet ID'); ?></label>
                                            <!--end::Label-->
                                        ...
                                        var fee = "<?php echo e(env('BETTINGCHARGE')); ?>";
                                        document.getElementById("totalrequest").innerHTML = '<?php echo e($general->cur_sym); ?>' + amount.value;
                                        document.getElementById("totalfee").innerHTML = '<?php echo e($general->cur_sym); ?>' + fee;
                                        document.getElementById("totalamount").innerHTML = '<?php echo e($general->cur_sym); ?>' + (parseInt(fee)+parseInt(amount.value));
                                        }
                                        </script>
                                        <script> 
                                            ...
                                            document.getElementById("customer").innerHTML = '';
                                                    $.ajax({
                                                        url: "<?php echo e(route('user.betting.wallet.verify')); ?>",
                                                        type: 'GET',
                                                        async: true,
                                                        data: 
                                                        {
                                                              ...
                                                              <td class="text-muted">
                                                                  <div class="d-flex align-items-center">
                                                                      <i class="ti ti-globe fs-2 me-2"><span
                                                                              ...
                                                                              class="path5"></span></i>
                                                                      <?php echo app('translator')->get('Betting Platform'); ?>
                                                              ...
                                                              <td class="text-muted">
                                                                  <div class="d-flex align-items-center">
                                                                      <i class="ti ti-gift fs-2 me-2"><span
                                                                              ...
                                                                              class="path3"></span><span
                                                                              class="path4"></span><span
                                                                              class="path5"></span></i> <?php echo app('translator')->get('Merchant'); ?>
                                                            ...
                                                            <td class="text-muted">
                                                                <div class="d-flex align-items-center">
                                                                    <i class="ti ti-percentage fs-2 me-2"><span
                                                                            class="path1"></span><span
                                                                            class="path2"></span></i> <?php echo app('translator')->get('Total Fee'); ?> 
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td class="text-muted">
                                                                <div class="d-flex align-items-center">
                                                                    <i class="ti ti-pig-money fs-2 me-2"><span
                                                                            class="path1"></span><span
                                                                            class="path2"></span></i> <?php echo app('translator')->get('Amount'); ?> 
                                                                </div>
                                                            </td>
                                        ...
                                        <div class="pb-8 pb-lg-10">
                                            ...
                                            <section class="payment-method text-center">
                                              ...
                                              <div class="d-sm-flex align-items-center justify-content-between my-4">
                                               <center>  <a href="<?php echo e(route('user.betting.history')); ?>" class="btn btn-primary d-block"><?php echo app('translator')->get('View Order'); ?></a> </center>
                                              </div>
                                            </section>
                                        </div> 
                                    </div>
                                        ...
                                        function() {
                                            ...
                                            function submitform()
                                            {
                                              ...
                                              var raw = JSON.stringify({
                                                ...
                                                fetch("<?php echo e(route('user.fund.betting.wallet')); ?>", requestOptions)
                                                  .then(response => response.text())
                                                  .then(result => 
                                                  {
                                                    resp = JSON.parse(result);
...
<?php echo $__env->make($activeTemplate . 'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/billspaypoint/core/resources/views/templates/basic/user/bills/betting/betting_buy.blade.php ENDPATH**/ ?>