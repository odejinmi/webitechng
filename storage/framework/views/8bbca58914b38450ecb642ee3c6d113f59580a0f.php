        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-7 text-center">
                    ...
                    <a href="<?php echo e(route('home')); ?>" class="btn--base mt-4"><?php echo app('translator')->get('Go to Home'); ?></a>
                </div>
            </div>
        </div>
    </div>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/billspaypoint/core/resources/views/errors/419.blade.php ENDPATH**/ ?>