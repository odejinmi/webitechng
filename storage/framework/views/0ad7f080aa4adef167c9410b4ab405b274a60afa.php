    ...
    <div class="row justify-content-center">
        <div class="col-xl-12">
            <div class="card b-radius--10 ">
                ...
                <div class="py-2 px-3">
                    <a href="<?php echo e(route('admin.system.optimize.clear')); ?>" class="btn btn-outline-primary w-100 h-45"><?php echo app('translator')->get('Click to clear'); ?></a>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/billspaypoint/core/resources/views/admin/system/optimize.blade.php ENDPATH**/ ?>