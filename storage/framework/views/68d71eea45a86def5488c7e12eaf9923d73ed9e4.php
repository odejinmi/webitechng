                        ...
                        >
                          <thead>
                            ...
                            <tr>
                                ...
                                <th class="text-center"><?php echo app('translator')->get('Code'); ?></th> 
                          ...
                          <tbody>
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = @$log; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $store): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                      <td> 
                                        <span class=""><?php echo e(__($store->name)); ?></span> 
                                      </td>
                                      <td> 
                                          <a>
                                              <span class="text-primary"><?php echo e(__($store->details)); ?></span> 
                                          </a>
                                      </td>

                                        <td class="text-center">
                                            <?php echo e(showDateTime($store->created_at)); ?><br><?php echo e(diffForHumans($store->created_at)); ?>

                                        </td> 
                                        <td class="text-center"> 
                                            <strong><?php echo e(($store->trx)); ?> </strong>                                        
                                        </td>
                                        <td class="text-center">
                                           <label class='badge text-white <?php if($store->status == 1): ?> bg-success <?php else: ?>  bg-danger <?php endif; ?>'> <?php if($store->status == 1): ?> Active <?php elseif($store->status == 2): ?> Pending Approval <?php else: ?> Inactive <?php endif; ?></label>
                                        </td> 
                                        <td>
                                          <a href="<?php echo e(route('user.storefront.edit',$store->trx)); ?>" class="btn btn-sm btn-primary">Manage</a>
                                        </td>
                                    </tr>
...
<?php echo $__env->make($activeTemplate . 'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/billspaypoint/core/resources/views/templates/basic/user/vendor/storefront/storefront_log.blade.php ENDPATH**/ ?>