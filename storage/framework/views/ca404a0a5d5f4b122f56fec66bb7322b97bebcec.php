...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        <label class="form-label mb-3"
                                            data-kt-translate="two-step-label"><?php echo app('translator')->get('Type your digit transaction code'); ?></label>
                                        <!--end::Label-->
    ...
    <?php $__env->stopPush(); ?>
<?php echo $__env->make($activeTemplate . 'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/billspaypoint/core/resources/views/templates/basic/user/bank/strowallet.blade.php ENDPATH**/ ?>