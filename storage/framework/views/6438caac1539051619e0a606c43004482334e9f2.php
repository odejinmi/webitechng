    ...
    <form action="<?php echo e(route('admin.setting.notification.template.update', $template->id)); ?>" method="post">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card mt-4">
                    <div class="card-header bg-light-primary">
                        <h5 class="card-title text-primary"><?php echo app('translator')->get('Email Template'); ?></h5>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-8">
                            ...
                            <div class="col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <div class="form-check form-switch form-check-success">
                                        <input type="checkbox" class="form-check-input"  <?php if($template->email_status): ?> checked <?php endif; ?> name="email_status"
                                         id="email_status" /> 
                                    </div> 
            ...
            <div class="col-md-6">
                <div class="card mt-4">
                    <div class="card-header bg-light-primary">
                        <h5 class="card-title text-primary"><?php echo app('translator')->get('SMS Template'); ?></h5>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group mb-3">
                                    <label><?php echo app('translator')->get('Status'); ?> <span class="text--danger">*</span></label>
                                    <div class="form-check form-switch form-check-success">
                                        <input type="checkbox" class="form-check-input"  <?php if($template->sms_status): ?> checked <?php endif; ?> name="sms_status"
                                         id="sms_status" /> 
                                    </div>  
                                </div>
                            </div>
        ...
        <button type="submit" class="btn btn-outline-primary w-100 h-45 mt-4"><?php echo app('translator')->get('Submit'); ?></button>
    </form>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/billspaypoint/core/resources/views/admin/notification/edit.blade.php ENDPATH**/ ?>