                      ...
                      <div class="table-responsive">
                        ...
                        >
                          ...
                          <tbody>
                            ...
                            <tr>
                              <td>
                                <a href="<?php echo e(route('admin.users.detail', $data->user_id)); ?>">
                                <div class="d-flex align-items-center">
                                  <img src="<?php echo e(getImage(getFilePath('userProfile') . '/' . @$data->user->image, getFileSize('userProfile'))); ?>" alt="avatar" class="rounded-circle" width="35" />
                                  <div class="ms-3">
                                    <div class="user-meta-info">
                                      <h6 class="user-name mb-0" data-name="<?php echo e(@$data->user->fullname); ?>"> <?php echo e(@$data->user->fullname); ?></h6>
                                      <span class="user-work fs-3" data-occupation="<?php echo e(@$data->user->username); ?>"> <?php echo e(@$data->user->username); ?></span>
                                    </div>
                                  </div>
                                </div>  
                                </a>
                              ...
                              <a href="<?php echo e(route('admin.savings.view',$data->reference)); ?>" class="btn btn-sm btn-primary">View</a>
                              </td>
                          </tr>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/itechng/core/resources/views/admin/savings/log.blade.php ENDPATH**/ ?>