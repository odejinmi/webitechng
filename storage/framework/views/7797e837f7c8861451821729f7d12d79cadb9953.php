                                            ...
                                            <select name="country" class="form-select form-select-solid"
                                                ...
                                                <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option data-countryname="<?php echo e($data['name']); ?>"
                                                        ...
                                                        data-logo="<?php echo e($data['flag']); ?>"
                                        ...
                                        <?php $__env->startPush('script'); ?>
                                            <script>
                                                ...
                                                `;
                                                    ...
                                                    $.ajax({
                                                        url: "<?php echo e(route('user.utility.operators')); ?>",
                                                        type: 'GET',
                                                        async: true,
                                                        data: 
                                                        {
                                ...
                                <div data-kt-stepper-element="content">
                                    ...
                                    <div class="w-100">
                                        ...
                                        <div class="fv-row mb-10">
                                            ...
                                            <!--begin::Input-->
                                            <input name="meter" id="meter" class="form-control form-control-lg form-control-solid"
                                                value="" />
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input group-->
                                        ...
                                        <div class="pb-8 pb-lg-10">
                                            ...
                                            <section class="payment-method text-center">
                                              ...
                                              <div class="d-sm-flex align-items-center justify-content-between my-4">
                                               <center>  <a href="<?php echo e(route('user.utility.history')); ?>" class="btn btn-primary d-block"><?php echo app('translator')->get('View Order'); ?></a> </center>
                                              </div>
                                            </section>
                                        </div> 
                                    </div>
                            ...
                            document.querySelector("#kt_create_account_stepper")) && (i = t.querySelector("#kt_create_account_form"), 
                                ...
                                fields: {
                                    ...
                                    meter: {
                                        validators: {
                                            notEmpty: {
                                                message: "Beneficiary meter number is required"
                                            }
                                        }
                                    }
                                },
                                        ...
                                        function() {
                                            ...
                                            function submitform()
                                            {
                                              ...
                                              var raw = JSON.stringify({
                                                ...
                                                fetch("<?php echo e(route('user.buy.utility')); ?>", requestOptions)
                                                  .then(response => response.text())
                                                  .then(result => 
                                                  {
                                                    resp = JSON.parse(result);
...
<?php echo $__env->make($activeTemplate . 'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ltecyxtc/public_html/core/resources/views/templates/basic/user/bills/utility/utility_buy.blade.php ENDPATH**/ ?>