    ...
    <div class="row">
          ...
          <div class="card w-100">
            <div class="card-body">
              ...
              <div id="stats" class="my-4">
                ...
                <span class="badge bg-success text-white">PIN: <?php echo e(strToUpper($reply['data']['pin'])); ?></span>
                <?php else: ?>
              ...
              <a  data-bs-toggle="modal" data-bs-target="#pin-modal" data-bs-whatever="@getbootstrap" href="#" class="btn btn-primary btn-sm"><i class="ti ti-key"></i> <?php echo app('translator')->get('Card Pin'); ?></a>
      ...
      <div class="modal fade" id="fund-modal" tabindex="-1" aria-labelledby="exampleModalLabel1">
        ...
        <?php $__env->startPush('breadcrumb-plugins'); ?>
            <a href="<?php echo e(route('user.virtualcard.index')); ?>" class="btn btn-primary">
                <i class="ti ti-plus"></i>
                <?php echo app('translator')->get('Request Card'); ?>
            </a>
        <?php $__env->stopPush(); ?>
...
<?php echo $__env->make($activeTemplate . 'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ltecyxtc/public_html/core/resources/views/templates/basic/user/vendor/virtualcard/details.blade.php ENDPATH**/ ?>