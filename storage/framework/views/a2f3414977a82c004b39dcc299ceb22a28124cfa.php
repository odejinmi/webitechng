<?php $__env->startSection('panel'); ?>
                            ...
                            <form class="card-body py-20 w-100 mw-xl-700px px-9" novalidate="novalidate"
                                ...
                                <div class="d-flex flex-stack pt-10">
                                    ...
                                    <div>
                                        ...
                                        <button type="button" onclick="submitform()" class="btn btn-lg btn-primary" id="submit">
                                            Continue
            ...
            <div class="modal-dialog modal-dialog-scrollable modal-lg">
                <div class="modal-content">
                    <div class="modal-body">
                        ...
                        <form class="ps-3 pr-3" action="<?php echo e(route('user.crypto.sell.confirm.manual')); ?>" method="POST"
                            enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="mb-3">
                                <label for="trxhash">TRX Number</label>
                                <input class="form-control" type="text" name="trxhash" id="trxhash" required=""
                                    placeholder="Please Enter Transaction Ref Number" />
                            </div>
    ...
    <?php $__env->startPush('breadcrumb'); ?>
        <a class="btn btn-sm btn-primary" href="<?php echo e(route('user.crypto.sell.log')); ?>"> <i class="ti ti-printer"></i>
            <?php echo app('translator')->get('Trade Log'); ?></a>
    <?php $__env->stopPush(); ?>

<?php echo $__env->make($activeTemplate . 'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DELL\PhpstormProjects\webitechng\resources\views/templates/satoshi/user/assets/crypto/sellcrypto/sell.blade.php ENDPATH**/ ?>