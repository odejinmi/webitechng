                                            ...
                                            <script>
                                                function networkprovider(operatorId,image,name,networkid) { 
                                                          ...
                                                          document.getElementById("networkid").value = networkid;
                                                                  ...
                                                                  fetch("<?php echo e(route('user.internet_sme.operatorsInternetdetailsNATKEMLINKS')); ?>", requestOptions)
                                                                      ...
                                                                      let htmlSegment = `
                                                                        <label class="d-flex flex-stack cursor-pointer mb-5" for="${plan['plan_id']}" >
                                                                          <span class="d-flex align-items-center me-2">
                                                                              ...
                                                                              <span class="d-flex flex-column">
                                                                                  <span class="fw-bold fs-6">${plan['network']} ${plan['plan_name']} <small>(${plan['plan_type']})</small></span>
                                                              ...
                                                              <td class="text-muted">
                                                                  <div class="d-flex align-items-center">
                                                                      <i class="ti ti-wifi fs-2 me-2"><span
                                                                              ...
                                                                              class="path5"></span></i> <?php echo app('translator')->get('Network'); ?>
                                                            ...
                                                            <td class="text-muted">
                                                                <div class="d-flex align-items-center">
                                                                    <i class="ti ti-gift fs-2 me-2"><span
                                                                            class="path1"></span><span
                                                                            class="path2"></span></i> <?php echo app('translator')->get('Data Plan'); ?>
                                        ...
                                        function() {
                                            ...
                                            function submitform()
                                            {
                                              ...
                                              var raw = JSON.stringify({
                                                ...
                                                fetch("<?php echo e(route('user.buy.internet_sme_natkemlinks')); ?>", requestOptions)
                                                  .then(response => response.text())
                                                  .then(result => 
                                                  {
                                                    resp = JSON.parse(result);
...
<?php echo $__env->make($activeTemplate . 'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/itechng/core/resources/views/templates/basic/user/bills/internetsme/internet_buy_NATKEMLINKS.blade.php ENDPATH**/ ?>