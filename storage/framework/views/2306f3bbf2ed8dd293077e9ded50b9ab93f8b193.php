            ...
            <div class="col-xl-6 col-lg-6">
                <div class="gray-simple rounded-2 py-3 px-3">
                    ...
                    <div class="row g-4 pb-4 pb-md-5 mb-3 mb-md-1">
                        ...
                        <div class="col-sm-12">
                            <label class="form-label fs-base">Amount <b>(<?php echo e($general->cur_text); ?>)</b></label>
...
<?php echo $__env->make($activeTemplate . 'layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/billspaypoint/core/resources/views/templates/basic/qr.blade.php ENDPATH**/ ?>