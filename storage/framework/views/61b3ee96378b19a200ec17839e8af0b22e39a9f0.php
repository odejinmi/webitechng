<?php $__env->startSection('panel'); ?>
        ...
        <div id="confirmPayment-modal" class="modal fade" tabindex="-1" aria-hidden="true">
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <form class="ps-3 pr-3" action="<?php echo e(route('user.crypto.buy.confirm.manual')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="mb-3">
                    <label for="trxhash">Enter Wallet Address</label>
                    <input class="form-control" type="text" name="walletaddress" id="walletaddress" required="" placeholder="Please Enter Wallet Address" />
                    </div>
                    <input id="trxnumber" name="trx" hiddens>
                    <div class="mb-3">
    ...
    <?php $__env->stopPush(); ?>
<?php echo $__env->make($activeTemplate . 'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/billspaypoint/core/resources/views/templates/basic/user/assets/crypto/buycrypto/buy.blade.php ENDPATH**/ ?>