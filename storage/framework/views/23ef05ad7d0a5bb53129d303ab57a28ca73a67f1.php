                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4 mb-15">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="currency" class="form-control border-radius-5"
                                                required value="<?php echo e(old('currency')); ?>" />
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" step="any" class="form-control" name="rate"
                                                    required value="<?php echo e(old('rate')); ?>" />
                                        ...
                                        <div class="card border-primary mt-3">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="number" step="any" class="form-control"
                                                            name="min_limit" required value="<?php echo e(old('min_limit')); ?>" />
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="number" step="any" class="form-control"
                                                            name="max_limit" required value="<?php echo e(old('max_limit')); ?>" />
                                                        <div class="input-group-text"><?php echo e(__($general->cur_text)); ?></div>
                                                    </div>
                                                </div>
                                            </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ltecyxtc/public_html/core/resources/views/admin/gateways/manual/create.blade.php ENDPATH**/ ?>