...
<header id="header" class="header tra-menu navbar-dark">
    <div class="header-wrapper">
       ...
       <span class="flaticon-phone-call bg-white theme-color"></span>+12 9 8765 4321
                        ...
                        <?php else: ?>
                            <li aria-haspopup="true"><a style="color:black;" href="#">Get Started <span
                                        class="wsarrow"></span></a>
                                <ul class="sub-menu">
                                    <li>
                                    ...
                                    <li>
                                        <a style="color:black;" href="<?php echo e(route('user.logout')); ?>">Register</a>
                                    </li>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/itechng/core/resources/views/templates/basic/partials/header.blade.php ENDPATH**/ ?>