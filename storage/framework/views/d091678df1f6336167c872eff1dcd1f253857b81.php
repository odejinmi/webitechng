...
<?php $__env->startPush('style-lib'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('assets/thirdparty/css/codemirror.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/thirdparty/css/monokai.min.css')); ?>">
<?php $__env->stopPush(); ?>
<?php $__env->startPush('script-lib'); ?>
    <script src="<?php echo e(asset('assets/thirdparty/js/codemirror.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/thirdparty/js/css.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/thirdparty/js/sublime.min.js')); ?>"></script>
<?php $__env->stopPush(); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ltecyxtc/public_html/core/resources/views/admin/setting/custom_css.blade.php ENDPATH**/ ?>