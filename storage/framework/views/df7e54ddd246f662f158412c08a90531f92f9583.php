                                                         ...
                                                         <?php $__env->startPush('script'); ?>
                                                          <script>
                                                            ...
                                                            function getplans(logo,networkid,network) {
                                                              ...
                                                              fetch("<?php echo e(route('user.internet_sme.operatorsInternetdetailsNATKEMLINKS')); ?>", requestOptions).then(response =>
...
<?php $__env->startPush('script'); ?>
    <script>
        function submitform() {
            ...
            fetch("<?php echo e(route('user.buy.internet_sme_natkemlinks')); ?>", requestOptions).then(response => response.text()).then(
                result => {
...
<?php echo $__env->make($activeTemplate . 'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ltecyxtc/public_html/core/resources/views/templates/satoshi/user/bills/internetsme/internet_buy_NATKEMLINKS.blade.php ENDPATH**/ ?>