    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="stepper stepper-links d-flex flex-column pt-15" id="kt_create_account_stepper">
                ...
                <!--begin::Form-->
                    <form  class="mx-auto mw-600px w-100 pt-15 pb-10" novalidate="novalidate" action="<?php echo e(route('user.withdraw.money')); ?>" method="post">
                    <?php echo csrf_field(); ?>
                    ...
                    <div data-kt-stepper-element="scontent">
                        ...
                        <div class="w-100">
                            ...
                            <div class="pb-10 pb-lg-15">
                                <!--begin::Title-->
                                <h2 class="fw-bold text-dark"><?php echo app('translator')->get('Wallet Payout'); ?></h2>
                                <!--end::Title-->
                                    ...
                                    <label class="d-flex flex-stack mb-5 cursor-pointer" for="<?php echo e($data->id); ?>">
                                        ...
                                        <span class="d-flex align-items-center me-2">
                                            ...
                                            <span class="d-flex flex-column">
                                                ...
                                                <span class="fs-6 fw-semibold text-muted"><?php echo e($general->cur_sym); ?><?php echo e(showAmount($data->min_limit )); ?> - <?php echo e($general->cur_sym); ?><?php echo e(showAmount($data->max_limit)); ?></span>
                                            </span>
                                            <!--end:Description-->
                                        </span>
                                        <!--end:Label-->
...
<?php $__env->startPush('breadcrumb-plugins'); ?>
    <a href="<?php echo e(route('user.withdraw.history')); ?>" class="btn btn-sm btn-primary">
        <i class="ti ti-printer"></i>
        <?php echo app('translator')->get('Payout Log'); ?>
    </a>
<?php $__env->stopPush(); ?>
...
<?php echo $__env->make($activeTemplate . 'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/billspaypoint/core/resources/views/templates/basic/user/withdraw/methods.blade.php ENDPATH**/ ?>