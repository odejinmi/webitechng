                ...
                <form action="" method="POST">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mt-4 d-none configForm" id="bulksmsng">
                            <div class="col-md-12">
                                <h6 class="mb-2"><?php echo app('translator')->get('Bulk SMS Nigeria Configuration'); ?></h6>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group mb-3">
                                    <label><?php echo app('translator')->get('API Token'); ?> </label>
                                    <input type="text" class="form-control" placeholder="<?php echo app('translator')->get('Token'); ?>"
                                        name="token"
                                        value="<?php echo e(@$general->sms_config->bulksmsng->token); ?>" />
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="<?php echo app('translator')->get('Sender'); ?>"
                                        name="sender"
                                        value="<?php echo e(@$general->sms_config->bulksmsng->sender); ?>" />
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn w-100 h-45 btn-outline-primary"><?php echo app('translator')->get('Submit'); ?></button>
                    </div>
                </form>
            </div><!-- card end -->
        </div>
...
<?php $__env->startPush('breadcrumb-plugins'); ?>
    <button type="button" data-bs-target="#testSMSModal" data-bs-toggle="modal"
        class="btn btn-outline-primary btn-sm"> <i class="ti ti-paper-plane"></i> <?php echo app('translator')->get('Send Test SMS'); ?></button>
<?php $__env->stopPush(); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DELL\PhpstormProjects\webitechng\resources\views/admin/notification/sms_setting.blade.php ENDPATH**/ ?>