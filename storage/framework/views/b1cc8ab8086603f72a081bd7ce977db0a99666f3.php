                    ...
                    <div class="card-body">
                        <div class="form-group mb-3">
                            ...
                            <select name="email_method" class="form-control">
                                <option value="php" <?php if($general->mail_config->name == 'php'): ?> selected <?php endif; ?>><?php echo app('translator')->get('PHP Mail'); ?>
                                </option>
                                <option value="smtp" <?php if($general->mail_config->name == 'smtp'): ?> selected <?php endif; ?>><?php echo app('translator')->get('SMTP'); ?>
                                </option>
                                <option value="sendgrid" <?php if($general->mail_config->name == 'sendgrid'): ?> selected <?php endif; ?>><?php echo app('translator')->get('SendGrid API'); ?>
                                </option>
                                <option value="mailjet" <?php if($general->mail_config->name == 'mailjet'): ?> selected <?php endif; ?>><?php echo app('translator')->get('Mailjet API'); ?>
                                </option>
                            </select>
                        </div>
                        <div class="row mt-4 d-none configForm" id="smtp">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="<?php echo app('translator')->get('Normally your email'); ?> address"
                                        name="username" value="<?php echo e($general->mail_config->username ?? ''); ?>" />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    <label><?php echo app('translator')->get('Password'); ?> </label>
                                    <input type="text" class="form-control" placeholder="<?php echo app('translator')->get('Normally your email password'); ?>"
                                        name="password" value="<?php echo e($general->mail_config->password ?? ''); ?>" />
                                </div>
                            </div>
                        </div>
                        <div class="row mt-4 d-none configForm" id="sendgrid">
                            ...
                            <div class="form-group col-md-12 mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="<?php echo app('translator')->get('SendGrid App key'); ?>" name="appkey"
                                    value="<?php echo e($general->mail_config->appkey ?? ''); ?>" />
                            </div>
                        </div>
                        <div class="row mt-4 d-none configForm" id="mailjet">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="<?php echo app('translator')->get('Mailjet Api Public Key'); ?>"
                                        name="public_key" value="<?php echo e($general->mail_config->public_key ?? ''); ?>" />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    <label><?php echo app('translator')->get('Api Secret Key'); ?> </label>
                                    <input type="text" class="form-control" placeholder="<?php echo app('translator')->get('Mailjet Api Secret Key'); ?>"
                                        name="secret_key" value="<?php echo e($general->mail_config->secret_key ?? ''); ?>" />
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php $__env->startPush('breadcrumb-plugins'); ?>
    <button type="button" data-bs-target="#testMailModal" data-bs-toggle="modal"
        class="btn btn-sm btn-outline-primary"><i class="las la-paper-plane"></i> <?php echo app('translator')->get('Send Test Mail'); ?></button>
<?php $__env->stopPush(); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/billspaypoint/core/resources/views/admin/notification/email_setting.blade.php ENDPATH**/ ?>