                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>&nbsp;</label>
                                        <button type="submit"
                                            class="btn btn-outline-primary w-100 h-45"><?php echo app('translator')->get('Submit'); ?></button>
                                    </div>
                                </div>
                            </div>
                        </form>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('admin.frontend.manage.section.update', $pdata->id)); ?>" method="post">
                                ...
                                <?php $__currentLoopData = json_decode($pdata->secs); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="highlight icon-move item">
                                        ...
                                        <span class="d-inline-block text-white me-auto ms-2">
                                            <?php echo e(__(@$sections[$sec]['name'])); ?></span>
                        ...
                        <button type="submit" class="btn btn-outline-primary w-100 h-45"><?php echo app('translator')->get('Update Now'); ?></button>
                    </form>
                                    ...
                                    <?php if($secs['builder']): ?>
                                        <div class="float-end d-inline-block manage-content">
                                            <a href="<?php echo e(route('admin.frontend.sections', $k)); ?>" target="_blank"
                                                ...
                                                title="<?php echo app('translator')->get('Manage Content'); ?>">
...
<?php $__env->startPush('script-lib'); ?>
    <script src="<?php echo e(asset('assets/thirdparty/js/jquery-sortable.js')); ?>"></script>
<?php $__env->stopPush(); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ltecyxtc/public_html/core/resources/views/admin/frontend/builder/index.blade.php ENDPATH**/ ?>