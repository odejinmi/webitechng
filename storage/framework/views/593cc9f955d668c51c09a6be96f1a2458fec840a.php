...
<head>
    ...
    <link href="<?php echo e(asset('assets/thirdparty/plugins/global/plugins.bundle.css')); ?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo e(asset('assets/thirdparty/css/style.bundle.css')); ?>" rel="stylesheet" type="text/css" />
    <!--end::Global Stylesheets Bundle-->
    <link  id="themeColors"  rel="stylesheet" href="<?php echo e(asset('assets/assets/dist/css/style-blue.min.css')); ?>" />
...
<body id="kt_body" class="auth-bg bgi-size-cover bgi-attachment-fixed bgi-position-center">
    ...
    <div class="d-flex flex-column flex-root">
        ...
        <style>
            body {
                background-image: url("<?php echo e(asset('assets/thirdparty/media/auth/bg10.jpeg')); ?>");
            }

            [data-bs-theme="dark"] body {
                background-image: url("<?php echo e(asset('assets/thirdparty/media/auth/bg10-dark.jpeg')); ?>");
            }
        </style>
        <!--end::Page bg image-->
  ...
  <a class='btn outl' href='<?php echo e(route('cookie.policy')); ?>'><?php echo app('translator')->get('Learn More'); ?></a>
        ...
        <!--begin::Javascript-->
        <script>
            var hostUrl = "<?php echo e(asset('assets/thirdparty/')); ?>";
        </script>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/billspaypoint/core/resources/views/templates/basic/layouts/auth.blade.php ENDPATH**/ ?>