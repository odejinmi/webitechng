                                            ...
                                            document.getElementById("customer").innerHTML = '';
                                                ...
                                                success: function(data) {
                                                 if(data.ok = true ){
                                                     ...
                                                     <br>
                                                     <span
                                                        class="mb-1 badge font-medium bg-light-primary text-primary"
                                                        >Customer Name: ${data.content}</span
                                                        >`;
                                                     document.getElementById("customername").value = data.content;
                                                     $("#loader").html('');
                                                    }else{
                                                     document.getElementById("returnreply").innerHTML = data.message;
                                                      $("#loader").html('');
                                                    }
...
<?php echo $__env->make($activeTemplate . 'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/billspaypoint/core/resources/views/templates/basic/user/bills/cabletv/cabletv_buy.blade.php ENDPATH**/ ?>