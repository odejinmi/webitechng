                            ...
                            <?php $__empty_1 = true; $__currentLoopData = @$log; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deposit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td>
                                            ...
                                            <br>
                                            <small> <?php echo e(__($deposit->val_i)); ?> </small>
                                        </td>
                                        ...
                                        <td class="text-center">
                                           <label class='badge <?php if($deposit->status == 'SUCCESSFUL'): ?> bg-success  <?php elseif($deposit->status == 'PENDING'): ?> bg-warning  <?php else: ?>  bg-danger <?php endif; ?>'> <?php echo $deposit->status ?></label>
                                        </td> 
                                    </tr>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ltecyxtc/public_html/core/resources/views/admin/bills/airtime/airtime_log.blade.php ENDPATH**/ ?>