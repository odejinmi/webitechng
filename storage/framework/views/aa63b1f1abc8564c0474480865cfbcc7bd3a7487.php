<?php $__env->startSection('panel'); ?>
    <div class="row">
        <div class="col-lg-12">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $allStaff; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $staff): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td><?php echo e(__($staff->name)); ?></td>
                                        <td><?php echo e($staff->email); ?></td>
                                        <td>
                                            <?php if($staff->role): ?>
                                                <?php echo e(__($staff->role->name)); ?>
            ...
            if($hasPermission == 1): ?>
                                                    <button type="button" class="btn btn-sm btn-outline-primary cuModalBtn" data-resource="<?php echo e($staff); ?>" data-modal_title="<?php echo app('translator')->get('Update Staff'); ?>">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ltecyxtc/public_html/core/resources/views/admin/staff/index.blade.php ENDPATH**/ ?>