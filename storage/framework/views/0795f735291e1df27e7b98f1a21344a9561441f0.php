                    ...
                    <div data-kt-stepper-element="scontent">
                        ...
                        <div class="w-100">
                            ...
                            <div class="pb-10 pb-lg-15">
                                <!--begin::Title-->
                                <h2 class="fw-bold text-dark"><?php echo app('translator')->get('Create Savings Plan'); ?></h2>
                                <!--end::Title-->
                            ...
                            <div class="mb-10 fv-row  red box">
                                <!--begin::Label-->
                                <label class="form-label mb-3"><?php echo app('translator')->get('Enter Recurrent Amount'); ?></label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="number" onkeyup="fixeamount(this)" id="amount" class="form-control form-control-lg form-control-solid  amount <?php $__errorArgs = ['ramount'];
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('ramount')); ?>" name="ramount" placeholder="0.00" />
                                <!--end::Input-->
                            </div>
                            <!--end::Input group--> 
                        ...
                        <div class="mb-1 form-password-toggle col-md-12">
                          ...
                          <?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="form-check mb-3">
                              <input class="form-check-input" type="radio" name="plan" id="reason<?php echo e($data->id); ?>" value="<?php echo e($data->id); ?>" checked>
                              <label class="form-check-label" for="reason<?php echo e($data->id); ?>">
...
<?php echo $__env->make($activeTemplate . 'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/billspaypoint/core/resources/views/templates/basic/user/vendor/savings/request.blade.php ENDPATH**/ ?>