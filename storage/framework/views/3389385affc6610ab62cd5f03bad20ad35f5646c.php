      ...
      <div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar>
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="<?php echo e(route('admin.scammers')); ?>" aria-expanded="false">
                <span>
                  <i class="ti ti-shield"></i>
                </span>
                <span class="hide-menu"><?php echo app('translator')->get('Scammer Attempts '); ?></span>
              </a>
            </li>
          ...
          <?php $hasPermission = App\Models\Role::hasPermission(['admin.users*'])  ? 1 : 0;
            ...
            <?php endif ?>
            <?php $hasPermission = App\Models\Role::hasPermission('admin.bonus')  ? 1 : 0;
            if($hasPermission == 1): ?>
            <li class="sidebar-item">
              <a class="sidebar-link" href="<?php echo e(route('admin.bonus.index')); ?>" aria-expanded="false">
                <span>
                  <i class="ti ti-user-circle"></i>
                </span>
                <span class="hide-menu"><?php echo app('translator')->get('Transaction Bonuses'); ?></span>
              </a>
            </li>
            <?php endif ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\PhpstormProjects\webitechng\resources\views/admin/partials/sidenav.blade.php ENDPATH**/ ?>