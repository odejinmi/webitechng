        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted">Current Exchange Rate: 1 RND = <?php echo e($currentRate); ?></p>
                </div>
                <div class="card-body">
                    <form action="<?php echo e(route('user.rnd.purchases.store')); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="alert alert-info">
                            ...
                            <ul class="mb-0">
                                ...
                                <li>Calculation: RND Amount × <?php echo e($currentRate); ?> = Total Amount</li>
...
<?php echo $__env->make($activeTemplate . 'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PhpstormProjects\webitechng\resources\views/templates/basic/user/rnd_purchases/create.blade.php ENDPATH**/ ?>