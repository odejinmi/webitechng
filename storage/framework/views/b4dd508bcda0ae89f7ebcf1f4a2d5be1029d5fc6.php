                            ...
                            <form class="card-body py-20 w-100 mw-xl-700px px-9" novalidate="novalidate"
                                ...
                                <div data-kt-stepper-element="content">
                                    ...
                                    <div class="w-100">
                                        ...
                                        <div class="pb-10 pb-lg-15">
                                            <!--begin::Title-->
                                            <h2 class="fw-bold text-dark"><?php echo app('translator')->get('Service Provider'); ?></h2>
                                            <!--end::Title-->
                                        ...
                                        <div class="mb-10 fv-row">
                                            <!--begin::Label-->
                                            <label class="form-label mb-3"><?php echo app('translator')->get('Select Service Provider'); ?></label>
                                            <!--end::Label-->
                                            ...
                                            document.getElementById('companyname').innerHTML = text;
                                             "
                                                data-control="select2" id="youSendCurrency" data-hide-search="false" data-placeholder="<?php echo app('translator')->get('Select Company'); ?>">
                                ...
                                <div data-kt-stepper-element="content">
                                    ...
                                    <div class="w-100">
                                        ...
                                        <div class="pb-10 pb-lg-12">
                                            ...
                                            <!--begin::Notice-->
                                            <div class="text-muted fw-semibold fs-6">
                                                <?php echo app('translator')->get('Please enter beneficiary\'s meter number and amount below'); ?></a>.
                                            </div>
                                            <!--end::Notice-->
                                        </div>
                                        <!--end::Heading-->
                                        ...
                                        <div class="fv-row mb-10">
                                            <!--begin::Label-->
                                            <label class="form-label required"><?php echo app('translator')->get('Enter '); ?> <a id="serviceprovider"></a> <?php echo app('translator')->get('meter number'); ?></label>
                                            <!--end::Label-->
                                                              ...
                                                              <td class="text-muted">
                                                                  <div class="d-flex align-items-center">
                                                                      <i class="ti ti-wifi fs-2 me-2"><span
                                                                              ...
                                                                              class="path3"></span><span
                                                                              class="path4"></span><span
                                                                              class="path5"></span></i> <?php echo app('translator')->get('Meter Type'); ?>
...
<?php echo $__env->make($activeTemplate . 'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DELL\PhpstormProjects\webitechng\resources\views/templates/basic/user/bills/utilityLocal/utility_buy.blade.php ENDPATH**/ ?>