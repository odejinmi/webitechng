                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card border-primary mt-3">
                                            ...
                                            <h5 class="card-header bg-light-primary"><?php echo app('translator')->get('Deposit Instruction'); ?></h5>
                                            <div class="card-body">
                                                <div class="form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card border-primary mt-3">
                                            <div class="card-header bg-light-primary d-flex justify-content-between">
                                                <h5 class="text-primary"><?php echo app('translator')->get('User Data'); ?></h5>
                                                <button type="button"
                                                    class="btn btn-sm btn-outline-primary float-end form-generate-btn"> <i
                                                        class="ti ti-plus"></i><?php echo app('translator')->get('Add New'); ?></button>
                                            </div>
                                            <div class="card-body">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="card border mb-3" id="<?php echo e($loop->index); ?>">
                                                                    ...
                                                                    <div class="card-body">
                                                                        ...
                                                                        ?>
                                                                        <div class="btn-group w-1s00">
                                                                            <button type="button"
                                                                                class="btn btn-outline-primary editFormData"
                                                                                data-form_item="<?php echo e($jsonData); ?>"
                                                                                data-update_id="<?php echo e($loop->index); ?>"><i
                                                                                    class="ti ti-edit"></i></button>
                                                                                    &nbsp;&nbsp;
                                                                            <button type="button"
                                                                                class="btn btn-outline-danger removeFormData"><i
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/billspaypoint/core/resources/views/admin/gateways/manual/edit.blade.php ENDPATH**/ ?>