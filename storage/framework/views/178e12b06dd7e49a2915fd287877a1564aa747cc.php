            ...
            <div class="row row-cols-xl-2 row-cols-md-2 g-6 mt-6">
                <div class="col">
                    <div class="card bg-warning bg-opacity-10 border-warning border-opacity-40">
                        <div class="p-5">
                            <div class="d-flex gap-3 mb-5"><img src="<?php echo e(url('/')); ?>/assets/images/provider/img-11.png"
                                    class="avatar" alt="...">
                                <div class=""><a class="d-inline-block text-sm text-heading fw-semibold"
                                        href="#">Transaction Value
                                    </a><span class="d-block text-xs text-muted">Utility</span></div>
                            </div>
                            <div class="d-flex align-items-end">
                                <div class="hstack gap-2">
                                    <span
                                        class="badge bg-warning bg-opacity-25 text-warning"><?php echo e($general->cur_sym); ?><?php echo e(number_format($value, 2)); ?></span>
                ...
                <div class="col">
                    <div class="card bg-success bg-opacity-10 border-success border-opacity-40">
                        <div class="p-5">
                            ...
                            <div class="d-flex align-items-end">
                                <div class="hstack gap-2">
                                    <span class="badge bg-success bg-opacity-25 text-success"><?php echo e(number_format($count)); ?></span>
        ...
        <div class="border-top">
            <div class="table-responsive">
                <table class="table table-hover table-striped table-nowrap">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $utilitylog; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center gap-3">
                                        <div class=""><a class="d-inline-block text-sm text-heading fw-semibold"
                                                href="#"><?php echo e(__(@strToUpper($data->product_logo))); ?><br>
                                                <small><?php echo e(__(@strToUpper($data->product_name))); ?></small>
                                ...
                                <td class="d-nons d-sm-table-cell"><?php echo e($data->val_1); ?><br>
                                <small>Meter: <?php echo e(__(@$data->val_2)); ?></small><br>
                                <small><?php echo e(__(@$data->deposit_code)); ?></small>
                                </td>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content overflow-hidden">
                <div class="modal-header pb-0 border-0">
                    <h1 class="modal-title h4" id="topUpModalLabel">Buy Electricity Token</h1>
                    ...
                    <form class="vstack gap-8">
                        ...
                        <div class="bg-body-secondary rounded-3 p-4">
                            ...
                            <div class="d-flex justify-content-between gap-2 mt-4">
                                <input type="number"  maxlength="11" id="meternumber"  onkeyup="validatemeter()"
                                    class="form-control form-control-flush text-xl fw-bold w-rem-40"
                                    placeholder="123********">
                                <input id="discos" value="ikeja-electric" hidden>

                                <button
                                    class="btn btn-sm btn-neutral rounded-pill shadow-none flex-none d-flex align-items-center gap-2 p-2"
                                    data-bs-toggle="dropdown" aria-expanded="false">
                                    <a id="networkimage"><img src="<?php echo e(url('/')); ?>/assets/images/provider/ikedc.png"
                                ...
                                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-sm">
                                    <?php $__currentLoopData = $networks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li onclick="verifynetwork(`<?php echo e($plan['name']); ?>`,`<?php echo e($plan['logo']); ?>`)"><a
                                                class="dropdown-item d-flex align-items-center gap-2" href="#">
                                                <img src="<?php echo e(url('/')); ?>/assets/images/provider/<?php echo e($plan['logo']); ?>"
                                    ...
                                    <?php $__env->startPush('script'); ?>
                                        <script>
                                            function verifynetwork(name, logo) {
                                                document.getElementById("networkimage").innerHTML =
                                                    `<img src="<?php echo e(url('/')); ?>/assets/images/provider/${logo}" class="w-rem-6 h-rem-6 rounded-circle"/>`;
                                                document.getElementById("discos").value = name;
                        ...
                        <input id="metertype" value="prepaid" hidden>
                        <?php $__env->startPush('script'); ?>
                        <script>
                            function setnumber(metertype) {
                            document.getElementById("amount").disabled = false;
                  ...
                  function validatemeter() {
                    ...
                    document.getElementById("password").disabled = true;
                        ...
                        $.ajax({
                            ...
                            company: document.getElementById("discos").value
                            },
                            async: true,
                            cache: false,
                            dataType: "json",
                        ...
                        <div class="bg-body-secondary rounded-3 p-4">
                            <div class="d-flex justify-content-between text-xs text-muted">
                                <span class="fw-semibold">Enter Amount</span> <span>Balance:
                                    <?php echo e(number_format(Auth::user()->balance, 2)); ?></span>
                            </div>
...
<?php $__env->startPush('breadcrumb'); ?>
    <button type="button" class="btn btn-sm btn-neutral d-sm-inline-flex" data-bs-target="#topUpModal"
        data-bs-toggle="modal">Buy Token</button>
<?php $__env->stopPush(); ?>
<?php $__env->startPush('script'); ?>
    <script>
        function submitform() {
            ...
            fetch("<?php echo e(route('user.buy.local.utility')); ?>", requestOptions).then(response => response.text()).then(
                result => {
...
<?php echo $__env->make($activeTemplate . 'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ltecyxtc/public_html/core/resources/views/templates/satoshi/user/bills/utilityLocal/utility_buy.blade.php ENDPATH**/ ?>