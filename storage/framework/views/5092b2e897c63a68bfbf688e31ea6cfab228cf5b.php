                            ...
                            <?php $__empty_1 = true; $__currentLoopData = @$log; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deposit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td>
                                            ...
                                            <br>
                                            <small> <?php echo e(__($deposit->trx)); ?> </small>
                                        </td>
                                        ...
                                        <td class="text-center">
                                           <small><?php echo e(__($general->cur_text)); ?> <?php echo e(showAmount($deposit->payment / $deposit->quantity)); ?></small>
                                            <br> 
                                            <strong><?php echo e(showAmount($deposit->price)); ?> <?php echo e(__($deposit->currency)); ?></strong>                                        </td>
                                        <td class="text-center">
                                           <label class='badge <?php if($deposit->status == 'delivered'): ?> bg-success <?php elseif($deposit->status == 'delivered'): ?> bg-success  <?php elseif($deposit->status == 'PENDING'): ?> bg-warning  <?php else: ?>  bg-danger <?php endif; ?>'> <?php echo $deposit->status ?></label>
                                        </td> 
                                    </tr>
...
<?php echo $__env->make($activeTemplate . 'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/billspaypoint/core/resources/views/templates/basic/user/bills/airtime/airtime_log.blade.php ENDPATH**/ ?>