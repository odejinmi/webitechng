        ...
        <div class="row d-flex align-items-center m-row">
            ...
            <div class="col-md-7 col-lg-6 m-top">
                <div class="hero-3-txt pc-10 mb-40 wow fadeInRight" data-wow-delay="0.4s">
                    ...
                    <!-- Title -->
                    <h2 class="h2-xl">Welcome To <?php echo e($general->site_name); ?></h2>

                    <!-- Text -->
                    <p class="p-md"><?php echo e($general->site_name); ?> <?php echo e($general->site_name); ?> makes it safe and easy to buy and sell Cryptocurrencies, Trade Gift card, shop with our Virtual USD and NGN dollar card, savings with interest and enjoy other bill payment services such as Cable, Electricity,Insurance, data and Airtime all using your local currency.
                    </p>
                ...
                <div class="col-md-7 col-lg-6">
                    <div class="txt-block right-column pc-30 mb-40 wow fadeInLeft" data-wow-delay="0.4s">
                        ...
                        <ul class="simple-list grey-color">
                            ...
                            <li class="list-item">
                                <p class="p-md">With <?php echo e($general->site_name); ?>, you can trade cryptocurrencies confidently, knowingthat yourtransactions are protected by robust security measures, safeguarding your assests and personal information
                                </p>
                            </li>

                            <li class="list-item">
                                <p class="p-md">Beyond Trading, <?php echo e($general->site_name); ?> offers a range of additional services such as Gift card Trades, Bill Payment, Virtual USD Cards, Savings Plan and a host of other needs that are met in a convenient platform
                                </p>
                            </li>
            ...
            <div class="row">
                <div class="col-lg-10 offset-lg-1">
                    <div class="section-title text-center mb-60">
                        ...
                        <!-- Text -->
                        <p class="p-xl">Choose <?php echo e($general->site_name); ?> for its comprehensive suite of Diverse services covering eveything, all convenietly accessible in one platform
                        </p>
                    ...
                    <div class="col-md-6">
                        <div class="fbox-3 pc-25 mb-40 wow fadeInUp" data-wow-delay="0.4s">
                            ...
                            <div class="fbox-txt">
                                ...
                                <!-- Text -->
                                <p class="p-md grey-color">Choosing <?php echo e($general->site_name); ?> for a savings plan means more personalized options, competitive interest rates and convinient features, ultimately helping you reach your financial goal efficiently.
                                </p>
                    ...
                    <div class="col-md-6">
                        <div class="fbox-3 pc-25 mb-40 wow fadeInUp" data-wow-delay="0.6s">
                            ...
                            <div class="fbox-txt">
                                ...
                                <!-- Text -->
                                <p class="p-md grey-color"><?php echo e($general->site_name); ?>'s Crypto Wallet offers secure, user-friendly management for digital assets with multi-currency support, robust security and potential DeFi integration
                                </p>
                    ...
                    <div class="col-md-6">
                        <div class="fbox-3 pc-25 mb-40 wow fadeInUp" data-wow-delay="1.4s">
                            ...
                            <div class="fbox-txt">
                                ...
                                <!-- Text -->
                                <p class="p-md grey-color"><?php echo e($general->site_name); ?> ensures concrete security measures, safeguarding user data and transactins through encryption,authentication protocols and proactive monitoring for threats
                                </p>
                ...
                <div class="row d-flex align-items-center m-row">
                    ...
                    <div class="col-md-7 col-lg-6 m-bottom">
                        <div class="txt-block left-column pc-30 mb-40 wow fadeInRight" data-wow-delay="0.6s">
                            ...
                            <!-- Title -->
                            <h3 class="h3-sm">Bills Payment Needs with <?php echo e($general->site_name); ?></h3>

                            <!-- Text -->
                            <p class="p-md grey-color">paying all your bill with <?php echo e($general->site_name); ?> is fast as the speed of light!
                            </p>
                    ...
                    <div class="col-md-7 col-lg-6">
                        <div class="txt-block right-column pc-30 mb-40 wow fadeInLeft" data-wow-delay="0.6s">
                            ...
                            <ul class="simple-list grey-color">
                                ...
                                <li class="list-item">
                                    <p class="p-md"> <strong>Gift Card:</strong>With <?php echo e($general->site_name); ?>'s gift card services, you can easily purchase gift cards for your favorite people,allowing you to treat them to their favorite stores or experiences
                                    </p>
                                </li>

                                <li class="list-item">
                                    <p class="p-md"><strong>Virtual Cards:</strong> <?php echo e($general->site_name); ?>'s Virtual Card feature enambles you to send virtual prepaid cards(USD/NGN) to your loved ones, providing them with a convenient and secure way to make onlibe purchases or manage expenses</p>
                                </li>

                                <li class="list-item">
                                    <p class="p-md"><strong>Savings:</strong> Utilize <?php echo e($general->site_name); ?>'s savings tools to set aside funds for special occasions of future gifts, ensuring that you can always show your appreciation to your favorite people when the time comes
                                    </p>
                                </li>
...
<?php echo $__env->make($activeTemplate . 'layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DELL\PhpstormProjects\webitechng\resources\views/templates/satoshi/home.blade.php ENDPATH**/ ?>