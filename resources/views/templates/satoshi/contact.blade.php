				 		...
				 		<div class="col-md-5 col-lg-4">
				 			<div class="contacts-info pc-30 mb-40">
								...
								<div class="contact-3-box mb-40 clearfix">
									...
									<p class="grey-color"><span>Phone :</span>  {{ __(@$addressContent->data_values->phone) }}</p>
									<p class="grey-color"><span>Email :</span> <a href="mailto:{{ __(@$addressContent->data_values->email) }}">{{ __(@$addressContent->data_values->email) }}</a></p>
								</div>
