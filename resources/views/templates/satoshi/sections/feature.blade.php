        ...
        <div class="row justify-content-center">
            <div class="col-xl-6 col-lg-10 col-md-12 col-sm-12 mb-5 wow animated fadeInUp">
                <div class="sec-heading center">
                    <br>
                    <div class="d-inline-flex px-4 py-1 rounded-5 text-info bg-light-info font--medium mb-2"><span>@lang('Our Features')</span></div>
                    <h2>{{ __(@$featureContent->data_values->heading) }}</h2>
                    <p class="text-slate-500">{{ __(@$featureContent->data_values->sub_heading) }}</p>
                </div>
            </div>
        </div>
