...
<head>
    ...
    <link href="{{ asset(checkTemplate(true) . 'front/css/azure-theme.css') }}" rel="stylesheet">
    ...
    <link href="{{ asset(checkTemplate(true) . 'front/css/slick-theme.css') }}" rel="stylesheet">
