...
<head>
    ...
    <link href="{{ asset($activeTemplateTrue . 'front/css/azure-theme.css') }}" rel="stylesheet">
    ...
    <link href="{{ asset($activeTemplateTrue . 'front/css/slick-theme.css') }}" rel="stylesheet">
