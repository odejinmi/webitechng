    ...
    <header>
        <nav class="navbar navbar-expand-lg transparent navbar-transparent navbar-dark">
            <div class="container px-3">
                <a class="navbar-brand" href="./index.html"><img src="{{ getImage(getFilePath('logoIcon') . '/logo.png') }}" width="50" alt /></a>
                <button class="navbar-toggler offcanvas-nav-btn" type="button">
                    <i class="bi bi-list"></i>
                </button>
                <div class="offcanvas offcanvas-start offcanvas-nav" style="width: 20rem">
                    <div class="offcanvas-header">
                        <a href="./index.html" class="text-inverse"><img src="{{ getImage(getFilePath('logoIcon') . '/logo.png') }}" width="50" alt /></a>
                    ...
                    <div class="offcanvas-body pt-0 align-items-center">
                        ...
                        <div class="mt-3 mt-lg-0 d-flex align-items-center">
                            @auth
                            <a href="{{ route('user.home') }}" class="btn btn-light mx-2">Account</a>
                            <a href="{{ route('user.logout') }}" class="btn btn-primary">Logout</a>
                            @else
                            <a href="{{ route('user.login') }}" class="btn btn-light mx-2">Login</a>
                            <a href="{{ route('user.register') }}" class="btn btn-primary">Create account</a>
                            @endauth
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
               <div class="col-xxl-5 col-lg-5 col-md-7">
                  <div class="mb-7 mb-xl-0">
                     <div class="mb-4">
                        <a href="#">
                           <img src="{{ getImage(getFilePath('logoIcon') . '/logo.png') }}" alt="logo"  width="50" class="text-inverse" />
                        </a>
                     </div>
                     <p class="mb-5">{{$general->site_name}} is a property of {{$general->site_name}}, a company duly registered with CAC with RC Number.</p>

                        <form class="needs-validation" method="post" action="{{ route('subscribe') }}" id="subscribeForm">
                        @csrf
                        <h5 class="mb-3">Subscribe to our newsletter</h5>
                        <div class="row g-2">
                           <div class="col-lg-9 col-8">
                              <label for="subscribeEmail" class="visually-hidden">Email</label>
                              <input type="email" class="form-control" name="email" id="subscribeEmail" placeholder="Email address" required />
                  ...
                  <div class="row" id="ft-links">
                        ...
                        <div class="position-relative">
                           ...
                           <div class="collapse d-lg-block" id="collapseLanding" data-bs-parent="#ft-links">
                              <ul class="list-unstyled mb-0 py-3 py-lg-0">
                                 ...
                                 <li class="mb-2">
                                    <a href="#!" class="text-decoration-none text-reset">Software</a>
                                 </li>
                                 <li class="mb-2">
                     ...
                     <div class="col-lg-4 col-12">
                        ...
                        <div class="collapse d-lg-block" id="collapseAccounts" data-bs-parent="#ft-links">
                           <ul class="list-unstyled mb-0 py-3 py-lg-0">
                              <li class="mb-2">
                                 <a href="{{route('user.register')}}" class="text-decoration-none text-reset">Register</a>
                              </li>
                              <li class="mb-2">
                                 <a href="{{route('user.login')}}" class="text-decoration-none text-reset">Login</a>
                              </li>
                              <li class="mb-2">
            ...
            <div class="row align-items-center">
               <div class="col-md-9">
                  <div class="small mb-3 mb-md-0">
                     ...
                     <span class="text-primary"><a href="#">{{$general->site_name}}</a></span>
                     | Designed by
                     <span class="text-primary"><a href="#">Khaytech Digitalz</a></span>
                  </div>
               </div>
               <div class="col-md-3">
