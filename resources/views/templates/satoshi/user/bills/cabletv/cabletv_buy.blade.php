            ...
            <div class="row row-cols-xl-4 row-cols-md-2 g-6 mt-6">
                <div class="col">
                    <div class="card bg-primary bg-opacity-10 border-primary border-opacity-40">
                        <div class="p-5">
                            <div class="d-flex gap-3 mb-5"><img src="{{ url('/') }}/assets/images/provider/dstv.jpg" class="avatar"
                                    alt="...">
                ...
                <div class="col">
                    <div class="card bg-warning bg-opacity-10 border-warning border-opacity-40">
                        <div class="p-5">
                            <div class="d-flex gap-3 mb-5"><img src="{{ url('/') }}/assets/images/provider/gotv.webp" class="avatar"
                                    alt="...">
                                <div class=""><a class="d-inline-block text-sm text-heading fw-semibold"
                                        href="#">GOTV
                ...
                <div class="col">
                    <div class="card bg-danger bg-opacity-10 border-danger border-opacity-40">
                        <div class="p-5">
                            <div class="d-flex gap-3 mb-5"><img src="{{ url('/') }}/assets/images/provider/starrtimes.png" class="avatar"
                                    alt="...">
                                <div class=""><a class="d-inline-block text-sm text-heading fw-semibold"
                ...
                <div class="col">
                    <div class="card bg-success bg-opacity-10 border-success border-opacity-40">
                        <div class="p-5">
                            <div class="d-flex gap-3 mb-5"><img src="{{ url('/') }}/assets/images/provider/showmax.svg" class="avatar"
                                    alt="...">
                                <div class=""><a class="d-inline-block text-sm text-heading fw-semibold"
                                                ...
                                                <button class="btn btn-sm btn-neutral rounded-pill shadow-none flex-none d-flex align-items-center gap-2 p-2" data-bs-toggle="dropdown" aria-expanded="false">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-sm">
                                                      @foreach (($networks) as $plan)
                                                        <li onclick="verifynetwork(`{{ $plan['logo'] }}`,`{{ $plan['name'] }}`)"><a class="dropdown-item d-flex align-items-center gap-2" href="#"><img src="{{ url('/') }}/assets/images/provider/{{ $plan['logo'] }}" class="w-rem-6 h-rem-6 rounded-circle" alt="...">
                                                         ...
                                                         @push('script')
                                                          <script>
                                                            ...
                                                            function getplans(logo,decoder) {
                                                              ...
                                                              fetch("{{ route('user.cabletv.operators') }}", requestOptions).then(response =>
...
@push('script')
    <script>
        function submitform() {
            ...
            fetch("{{ route('user.buy.cabletv') }}", requestOptions).then(response => response.text()).then(
                result => {
