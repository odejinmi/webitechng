                ...
                <div class="col">
                    <div class="card bg-success bg-opacity-10 border-success border-opacity-40">
                        <div class="p-5">
                            ...
                            <div class="d-flex align-items-end">
                                <div class="hstack gap-2">
                                    <span class="badge bg-success bg-opacity-25 text-success">{{ number_format($count) }}</span>
                                        ...
                                        <script>
                                            function verifynetwork(name, logo) {
                                                document.getElementById("networkimage").innerHTML =
                                                    `<img src="{{ url('/') }}/assets/images/provider/${logo}" class="w-rem-6 h-rem-6 rounded-circle"/>`;
...
@push('script')
    <script>
        function submitform() {
            ...
            fetch("{{ route('user.buy.local.utility') }}", requestOptions).then(response => response.text()).then(
                result => {
