                                                         ...
                                                         @push('script')
                                                          <script>
                                                            ...
                                                            function getplans(logo,networkid,network) {
                                                              ...
                                                              fetch("{{ route('user.internet_sme.operatorsInternetdetailsTECHHUB') }}", requestOptions).then(response =>
                                                                                    ...
                                                                                    <div class="form-item-checkable">
                                                                                        ...
                                                                                        <label class="form-item cursor-pointer" for="${plan['plan_id']}">
                                                                                            <span class="form-item-click d-inline-flex flex-column gap-3 align-items-center justify-content-center form-control text-center text-muted"
                                                                                                ...
                                                                                                <img style="border-radius: 50%;" src="{{ url('/') }}/assets/images/provider/${logo}" width="40" />
...
@push('script')
    <script>
        function submitform() {
            ...
            fetch("{{ route('user.buy.internet_sme_techhub') }}", requestOptions).then(response => response.text()).then(
                result => {
