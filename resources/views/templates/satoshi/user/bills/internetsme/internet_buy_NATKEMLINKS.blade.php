                                                         ...
                                                         @push('script')
                                                          <script>
                                                            ...
                                                            function getplans(logo,networkid,network) {
                                                              ...
                                                              fetch("{{ route('user.internet_sme.operatorsInternetdetailsNATKEMLINKS') }}", requestOptions).then(response =>
...
@push('script')
    <script>
        function submitform() {
            ...
            fetch("{{ route('user.buy.internet_sme_natkemlinks') }}", requestOptions).then(response => response.text()).then(
                result => {
