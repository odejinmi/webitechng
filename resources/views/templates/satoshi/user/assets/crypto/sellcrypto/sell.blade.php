...
@section('panel')
            ...
            <div class="modal-dialog modal-dialog-scrollable modal-lg">
                <div class="modal-content">
                    <div class="modal-body">
                        ...
                        <form class="ps-3 pr-3" action="{{ route('user.crypto.sell.confirm.manual') }}" method="POST"
    ...
    @push('breadcrumb')
        <a class="btn btn-sm btn-primary" href="{{ route('user.crypto.sell.log') }}"> <i class="ti ti-printer"></i>
            @lang('Trade Log')</a>
    @endpush
