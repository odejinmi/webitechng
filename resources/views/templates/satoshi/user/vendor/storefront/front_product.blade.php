                                ...
                                <div class="row align-items-center">
                                    <div class="col-9">
                                        ...
                                        <nav aria-label="breadcrumb">
                                            ...
                                            <img src="{{ getImage(imagePath()['storefront_logo']['path'] . '/' . $storefront->logo, imagePath()['storefront_logo']['size']) }}"
                                                alt="" class="img-fluid" width="40" />
                                        </nav>
                                    </div>
                                    <div class="col-3">
                                        <div class="text-center mb-n5">
                                            <img src="{{ getImage(imagePath()['storefront_header']['path'] . '/' . $storefront->header, imagePath()['storefront_header']['size']) }}"
                                        ...
                                        <div class="col-lg-6">
                                            <div id="sync1" class="owl-carousel owl-theme">
                                                <div class="item rounded overflow-hidden">
                                                    <img src="{{getImage(imagePath()['storefront_product']['path'].'/'. $product->image,imagePath()['storefront_product']['size'])}}" alt=""
                                                        class="img-fluid">
                                                </div>
                                                <div class="item rounded overflow-hidden">
