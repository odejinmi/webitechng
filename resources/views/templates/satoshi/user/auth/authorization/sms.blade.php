...
<div class="row g-0 justify-content-center gradient-bottom-right start-purple middle-indigo end-pink">
        <div
            ...
            <div class="p-12 py-xl-10 px-xl-20"><a class="d-block"
                ...
                <div class="mt-16">
                    <h1 class="ls-tight fw-bolder display-6 text-white mb-5">Phone Verification
                    </h1>
                    <p class="text-white text-opacity-75 pe-xl-24">Please validate your phone address</p>
                </div>
            </div>
        ...
        <div
            ...
            <div class="w-md-50 mx-auto px-10 px-md-0 py-10">
                <div class="mb-10"><a class="d-inline-block d-lg-none mb-10"
                    ...
                    <h4 class="ls-tight fw-bolder h3">@lang('A 6 digit verification code sent to your email address') : {{ showEmailAddress(auth()->user()->mobile) }}</h4>

                </div>
                <form class="crancy-wc__form-main  verify-gcaptcha" novalidate="novalidate" id="login_form"
                                method="POST" action="{{ route('user.verify.mobile') }}">
                                @csrf
                ...
                <div class="row g-2">
                    <div class="col-sm-12"><a href="{{ route('user.send.verify.code', 'sms') }}" class="btn btn-neutral w-100"><span class="icon icon-sm pe-2"> </span>Resend</a>
                    </div>
