							...
							<div class="col-md-7 col-lg-6">
								<div class="txt-block right-column pc-30 mb-40 wow fadeInLeft" data-wow-delay="0.6s">
									...
									<ul class="simple-list grey-color">
										...
										<li class="list-item">
											<p class="p-md">Top-up your internet Data on your various networks (Mtn, Glo, Airtel, 9mobile, spectranet, smile) Directly from your {{$general->site_name}} crypto wallet.
											</p>
										</li>
							...
							<div class="col-md-7 col-lg-6 m-bottom">
								<div class="txt-block left-column pc-30 mb-40 wow fadeInRight" data-wow-delay="0.6s">
									...
									<ul class="simple-list grey-color">
										...
										<li class="list-item">
											<p class="p-md">Let {{$general->site_name}} crypto be the source of electricity in your household by making payment directly from your {{$general->site_name}} crypto wallet.
											</p>
										</li>
