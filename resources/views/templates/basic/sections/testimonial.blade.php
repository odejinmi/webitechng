				...
				<div class="container">
					<div class="row justify-content-center">
						<div class="col-xl-8 col-lg-9 col-md-12 col-sm-12">
                            <center>
                            <h2 class="mb-3 lh-base">{{ __(@$testimonialContent->data_values->heading) }}</h2>
                            <p class="mb-0 fs-5 fw-light">{{ __(@$testimonialContent->data_values->sub_heading) }}</p>
                            </center>
								...
								<div class="sng-revs-wrap text-center mb-4">
									<div class="sng-revs-thumber mb-4">
										...
										<div class="sng-revs-usrcaps">
											<h5 class="mb-1">{{ __(@$item->data_values->name) }}</h5>
											<p class="mb-0 text-muted">{{ __(@$item->data_values->designation) }}</p>
										</div>
									</div>
									<div class="sng-revs-desc">
										...
										<div class="text-center">
											<p class="text-center fs-5 fw-light mb-0">"{{ __(@$item->data_values->review) }}"</p>
										</div>
									</div>								
								</div>
                                @empty
