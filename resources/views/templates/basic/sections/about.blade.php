            ...
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                <div class="position-relative exloi">
                    <div class="position-relative pe-4 pb-4">
                        <img src="{{ __(getImage('assets/images/frontend/about_1/'.@$aboutContent->data_values->image,'1920x1281')) }}" class="img-fluid rounded-4" alt="">
                    </div>
            ...
            <div class="col-xl-5 col-lg-5 col-md-12 col-sm-12">
                <div class="position-relative exloi py-lg-0 py-4">
                    <div class="exloi-caption">
                        ...
                        <h2 class="display-5 font--bold lh-base mb-3">{{ __(@$aboutContent->data_values->title) }}</h2>
                        ...
                        <div class="exloi-link mt-4">
                            <a href="{{route('blog')}}" class="btn btn-primary font--medium rounded-5">@lang('Blog')<i class="fa-regular fa-circle-right ms-2"></i></a>
                        </div>
                    </div>
                </div>
            </div> 
