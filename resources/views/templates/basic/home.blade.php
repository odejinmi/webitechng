            ...
            <div class="row d-flex align-items-center m-row">
                ...
                <div class="col-md-7 col-lg-6 m-top">
                    <div class="hero-3-txt pc-10 mb-40 wow fadeInRight" data-wow-delay="0.4s">
                        ...
                        <!-- Text -->
                        <p class="p-md">{{ $general->site_name }} makes it safe and easy to buy and sell Cryptocurrencies, Trade Gift card, shop with our Virtual USD and NGN dollar card, savings with interest and enjoy other bill payment services such as Cable, Electricity,Insurance, data and Airtime all using your local currency.
                        </p>
            ...
            <div class="row d-flex align-items-center">
                ...
                <div class="col-md-7 col-lg-6">
                    <div class="txt-block right-column pc-30 mb-40 wow fadeInLeft" data-wow-delay="0.4s">
                        ...
                        <!-- Button -->
                        <a href="{{ route('user.home') }}" class="btn btn-md btn-tra-grey theme-hover">Get Started</a>
