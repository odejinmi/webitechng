...
@section('panel')
            ...
            <div class="card">
                ...
                <div class="card-body">
                        ...
                        <div class="notice d-flex bg-light-warning rounded border-warning border border-dashed  p-6">
                            ...
                            <div class="d-flex flex-stack flex-grow-1 ">
                                ...
                                <div class=" fw-semibold">
                                    <h4 class="text-gray-900 fw-bold">@lang('Create Savings')</h4>

                                    <div class="fs-6 text-gray-700 ">@lang('Welcome to our savings plan portal where you can create savings plan on the platform<br>
                    ...
                    <div class="text-center pb-15 px-5">
                        <img src="{{ asset('assets/assets/dist/images/backgrounds/savings.png') }}" alt="" class="mw-100 h-200px h-sm-325px" />
                    </div>
                    <!--end::Illustration-->
                </div>
                <!--end::Card body-->
    ...
    @push('breadcrumb-plugins')
        <a class="btn btn-sm btn-primary" href="{{ route('user.savings.history') }}"> <i class="ti ti-printer"></i> @lang('My Savings')</a>
    @endpush
    @push('script')
    @endpush
