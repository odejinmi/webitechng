                                ...
                                <div data-kt-stepper-element="content">
                                    ...
                                    <div class="w-100">
                                        ...
                                        <div class="pb-10 pb-lg-12">
                                            ...
                                            <!--begin::Notice-->
                                            <div class="text-muted fw-semibold fs-6">
                                                @lang('Please enter beneficiary\'s decoder number and amount below')</a>.
                                            </div>
                                            <!--end::Notice-->
                                        </div>
                                        <!--end::Heading-->
                                        ...
                                        <div class="fv-row mb-10">
                                            <!--begin::Label-->
                                            <label class="form-label required">@lang('Enter ') <a id="serviceprovider"></a> @lang('Decoder Number')</label>
                                            <!--end::Label-->
                                        ...
                                        <div class="pb-8 pb-lg-10">
                                            ...
                                            <section class="payment-method text-center">
                                              ...
                                              <div class="d-sm-flex align-items-center justify-content-between my-4">
                                               <center>  <a href="{{ route('user.cabletv.history') }}" class="btn btn-primary d-block">@lang('View Order')</a> </center>
                                              </div>
                                            </section>
                                        </div> 
                                    </div>
