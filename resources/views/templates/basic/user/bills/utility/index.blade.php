...
@section('panel')
                        ...
                        <div class="notice d-flex bg-light-warning rounded border-warning border border-dashed  p-6">
                            ...
                            <div class="d-flex flex-stack flex-grow-1 ">
                                ...
                                <div class=" fw-semibold">
                                    ...
                                    <div class="fs-6 text-gray-700 ">@lang('Welcome to our global utility bills payment system where you can pay utility bills from over 700 utility service providers and 300+ countries across the world<br>
                                   <b> You can click on the Utility log button at the top right corner of your screen to view your bill payment log</b>
                                    ')
                                        <br> <br>
                                        <!--begin::Action-->
                                        <a href="{{ route('user.buy.utility') }}" class="btn btn-primary er fs-6 px-8 py-4">
    ...
    @push('breadcrumb-plugins')
        <a class="btn btn-sm btn-primary" href="{{ route('user.utility.history') }}"> <i class="ti ti-printer"></i> @lang('Utility Log')</a>
    @endpush
    @push('script')
    @endpush
