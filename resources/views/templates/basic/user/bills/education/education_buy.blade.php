                                        ...
                                        @push('script')
                                            <script>
                                                ...
                                                `;
                                                    ...
                                                    $.ajax({
                                                        url: "{{ route('user.education.operators') }}",
                                                        type: 'GET',
                                                        async: true,
                                                        data:
                                                        {
                                            ...
                                            <script>
                                              function networkprovider(network) {
                                                ...
                                                console.log('hima',str[str.length - 1]);
                                                        ...
                                                        document.getElementById("plan").value = `${variantcode}`;
                                                        document.getElementById("networkprovider").innerHTML = network;
                                                        document.getElementById("plan").value = network;
                                                        document.getElementById("totalamount").innerHTML = '{{$general->cur_sym}}'+planamount;
                                ...
                                <div data-kt-stepper-element="content">
                                    ...
                                    <div class="w-100">
                                        ...
                                        <div class="fv-row mb-10">
                                            <!--begin::Label-->
                                            <label class="form-label required">@lang('Enter ') <a id="serviceprovider"></a> @lang('Phone Number')</label>
                                            <!--end::Label-->

                                            <!--begin::Input-->
                                            <input name="decoder" id="decoder"  class="form-control form-control-lg form-control-solid"/>
                                            <div id="profilecodediv" hidden>
                                            <label class="form-label required">@lang('Enter ') <a id="profilecode"></a> @lang('Profilecode')</label>
                                            <!--end::Label-->
                                        ...
                                        <div class="pb-8 pb-lg-10">
                                            ...
                                            <section class="payment-method text-center">
                                              ...
                                              <div class="d-sm-flex align-items-center justify-content-between my-4">
                                               <center>  <a href="{{ route('user.education.history') }}" class="btn btn-primary d-block">@lang('View Order')</a> </center>
                                              </div>
                                            </section>
                                        </div>
                                    </div>
