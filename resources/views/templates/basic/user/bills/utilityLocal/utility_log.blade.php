                          ...
                          <thead>
                            ...
                            <tr>
                                ...
                                <th class="text-center">@lang('Beneficiary')</th>
                                 ...
                                 <th class="text-center">@lang('Token')</th>
                                    ...
                                    <tr>
                                        <td>
                                            <span class="fw-bold"> 
                                              ...
                                              <span
                                                    class="text-primary">{{ __($deposit->product_logo) }}</span>
                                            </span>
                                            <br>
                                            <small> {{ __($deposit->product_name) }} </small>
                                        </td>
                                        ...
                                        <td class="text-center">
                                           <small>{{ __($general->cur_text) }} {{ showAmount($deposit->price / $deposit->quantity) }}</small>
                                            <br>
                                            <strong>{{ showAmount($deposit->price) }} {{ __($general->cur_text) }}</strong>
                                        </td>
                                        <td class="text-center"> 
                                            <strong>{{ $deposit->deposit_code }} </strong>
                                        </td>
                                        <td class="text-center">
                                           <label class='badge @if($deposit->status == 'delivered') bg-success @else  bg-danger @endif'> @php echo $deposit->status @endphp</label>
                                        </td> 
                                    </tr>
                                @empty
                                    {!!emptyData2()!!}
