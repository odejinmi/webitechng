...
<div class="d-flex flex-column flex-lg-row flex-column-fluid">
    ...
    <div class="d-flex flex-lg-row-fluid">
        ...
        <div class="d-flex flex-column flex-center pb-0 pb-lg-10 p-10 w-100">
            ...
            <img class="theme-light-show mx-auto mw-100 w-150px w-lg-300px mb-10 mb-lg-20"
                src="{{ getImage('assets/images/frontend/smsauth/' . @$passwordContent->data_values->image, '630x540') }}"
                alt="" />
        ...
        <div class="bg-body d-flex flex-column flex-center rounded-4 w-md-600px p-10">
            ...
            <div class="d-flex flex-center flex-column align-items-stretch h-lg-100 w-md-400px">
                ...
                <div class="d-flex flex-center flex-column flex-column-fluid pb-15 pb-lg-20">
                    ...
                    action="{{ route('user.verify.mobile') }}">
                    @csrf
                     <!--begin::Icon-->
                    ...
                    <!--end::Icon-->
                        ...
                        <div class="text-center mb-11">
                            ...
                            <div class="text-gray-500 fw-semibold fs-6">
                                <p class="fw-bold text-start text-dark fs-6 mb-1 ms-1">@lang('A 6 digit verification code sent to your registered phone number') :{{ showMobileNumber(auth()->user()->mobile) }}</p>
                            </div>
                            <!--end::Subtitle--->
                        </div>
                        <!--begin::Heading-->
    ...
    <!--end::Section-->
                    ...
                    <!--end::Form-->
                    <p>
                        @lang('If you don\'t get any code'), <a href="{{ route('user.send.verify.code', 'sms') }}"
                            class="text--base">
                            @lang('Try again')</a>
                    </p>
