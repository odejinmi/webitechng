            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
              <div class="d-lg-none d-flex">
                <select id="country" onchange="fetch_data(10,1)" class="selectpicker show-tick">
                  <option>@lang('Filter By Country')</option>
...
function fetch_data(perpage, pagenum){
    ...
    let url = `{{route('user.fecthgiftcards')}}?page=${pagenum}&countryCode=${iso ? iso : ''}&productName=${search ? search : ''}`;
        ...
        <div class="col-sm-6 col-xl-4">
                <div class="card hover-img overflow-hidden rounded-2">
                  <div class="position-relative">
                    ...
                    <a href="{{route('user.giftcard')}}?id=${card.productId}" class="bg-primary rounded-circle p-2 text-white d-inline-flex position-absolute bottom-0 end-0 mb-n3 me-3" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add To Cart"><i class="ti ti-basket fs-4"></i></a>                      </div>
