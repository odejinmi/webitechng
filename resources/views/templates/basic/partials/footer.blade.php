					...
					<div class="row">
						...
						<div class="col-md-10 col-lg-5 col-xl-4">
							<div class="footer-info mb-40">
								...
								<!-- Footer Logo -->	
								<div class="footer-logo"><img src="{{ getImage(getFilePath('logoIcon') . '/logo.png') }}" alt="footer-logo"/></div>
						...
						<div class="col-md-3 col-lg-2 col-xl-2 offset-xl-1">
							<div class="footer-links mb-40">
								...
								<ul class="clearfix">									
									...
									<li><p><a href="{{route('custompage','product')}}">Product Updates</a></p></li>
						...
						<div class="col-md-3 col-lg-2 col-xl-2">
							<div class="footer-links mb-40">
								...
								<!-- Footer Links -->
								<ul class="clearfix">								
									<li><p><a href="{{route('custompage','policy')}}">Privacy Policy</a></p></li>							
									<li><p><a href="{{route('custompage','career')}}">Career</a></p></li>	
									<li><p><a href="">Advertising</a></p></li>	
									<li><p><a href="{{route('custompage','terms')}}">Terms</a></p></li>
						...
						<div class="row d-flex align-items-center">
							...
							<div class="col-lg-6">
								<div class="footer-copyright">
									<p>&copy; {{date('Y')}} {{$general->site_name}}. All Rights Reserved</p>
								</div>
							</div>
