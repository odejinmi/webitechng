						...
						<div class="col-xl-10 offset-xl-1">
							<div class="service-txt mb-70">
								...
								<p class="p-md"> To the ultimate digital asset exchange platform. Our solutions are built on blockchain technology to meet and exceed the expectations of new and existing clients. 
                                                At {{$general->site_name}}, you enjoy optimum value for your money when you buy, sell or store Bitcoin, Ethereum, Ripple coin, Dogecoin, Litecoin and other cryptocurrencies.
