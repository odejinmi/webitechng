                        ...
                        <div class="row justify-content-between mt-3">
                            ...
                            <div class="col-md-5 mt-md-0 mt-3">
                                <button type="button" data-bs-toggle="modal" data-bs-target="#addModal"
                                    class="btn btn-sm btn-outline-primary float-end"><i class="fa fa-plus"></i>
                                ...
                                <tbody>
                                    ...
                                    @forelse($json as $k => $language)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="javascript:void(0)" data-bs-target="#editModal"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-outline-primary import_lang"> @lang('Import Now')</button>
                </div>
            </div>
        </div>
    </div>
...
@push('breadcrumb-plugins')
    <button type="button" class="btn btn-sm btn-outline-primary box--shadow1 importBtn"><i
