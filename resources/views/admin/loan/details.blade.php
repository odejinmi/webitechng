                        ...
                        <div class="row mt-4">
                            <div class="col-md-12">
                                @can('admin.loan.approve')
                                    <button class="btn btn-success confirmationBtn" data-action="{{ route('admin.loan.approve', $loan->id) }}" data-question="@lang('Are you sure to approve this loan?')">
                                        <i class="fas la-check"></i> @lang('Approve')
                                    </button>
                                @endcan

                                @can('admin.loan.reject')
                                    <button class="btn btn-danger ms-1 rejectBtn" data-action="{{ route('admin.loan.reject', $loan->id) }}">
