                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if ($loan->nextInstallment)
                                                <span class="text--info"> {{ showDateTime($loan->nextInstallment->installment_date, 'd M, Y') }}</span>
                                            @else
                                            ...
                                            @php echo $loan->status_badge; @endphp
                                             ...
                                             <td>
                                                <div class="button--group">
                                                         <a class="btn btn-sm btn-primary" href="{{ route('admin.loan.details', $loan->id) }}">
                                                            <i class="las la-desktop"></i> @lang('Details')
                                                        </a>
                                                          <a class="btn btn-sm btn-success" href="{{ route('admin.loan.installments', $loan->id) }}">
