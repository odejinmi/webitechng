              ...
              <tr>
                ...
                <td>
                  <div class="d-flex align-items-center">
                    <img src="{{getImage(imagePath()['city']['path'].'/'. $city->image,imagePath()['city']['size'])}}" class="rounded-circle" alt="..." width="56"
                      height="56">
                    <div class="ms-3">
                      <h6 class="fw-semibold mb-0 fs-4">{{$city->name}}</h6>
                    </div>
                  </div>
                </td>
                <td>
                  <p class="mb-0">{{$city->created_at}}</p>
                </td>
                <td>
                    @if($city->status == 1)
                    <div class="d-flex align-items-center">
