                                          ...
                                          <div class="modal-body p-4">
                                            <div class="text-center text-success">
                                              ...
                                              <p class="mt-3 text-success-50">
                                                @lang('You are about to approve this transaction. Please click on the continue button below to continue process')<br>
                                                <b class="text-danger">Ensure you have made payment to Beneficiary Wallet Address: {{$deposit->val_1}}</b>

                                              </p>
                                              <button type="button" class="btn btn-light my-2"  data-bs-dismiss="modal">
                                                Cancel
                                              </button>
                                              <a href="{{route('admin.crypto.assetbuytrade.approve',$deposit->trx)}}" class="btn btn-success my-2">
                                                Continue
                                              </a>
                                            </div>
                                          </div>
                                        ...
                                        >
                                          <div class="modal-body p-4">
                                            <div class="text-center text-danger">
                                              ...
                                              <a href="{{route('admin.crypto.assetbuytrade.decline',$deposit->trx)}}" class="btn btn-danger my-2">
                                                Continue
                                              </a>
                                            </div>
                                          </div>
