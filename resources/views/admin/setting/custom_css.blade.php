...
@endpush
@push('style-lib')
    <link rel="stylesheet" href="{{asset('assets/thirdparty/css/codemirror.min.css')}}">
    <link rel="stylesheet" href="{{asset('assets/thirdparty/css/monokai.min.css')}}">
@endpush
@push('script-lib')
    <script src="{{asset('assets/thirdparty/js/codemirror.min.js')}}"></script>
    <script src="{{asset('assets/thirdparty/js/css.min.js')}}"></script>
    <script src="{{asset('assets/thirdparty/js/sublime.min.js')}}"></script>
@endpush
@push('script')
<script>
    "use strict";
