                                            ...
                                            <td>
                                                <div class="button--group">
                                                    @can('admin.plans.loan.edit')
                                                        <a href="{{ route('admin.plans.loan.edit', $plan->id) }}" class="btn btn-sm btn-primary">
                                                    ...
                                                    @can('admin.plans.loan.status')
                                                        @if ($plan->status)
                                                            <button type="button" data-action="{{ route('admin.plans.loan.status', $plan->id) }}" data-question="@lang('Are you sure to disable this plan?')" class="btn btn-sm confirmationBtn btn-danger">
                                                                <i class="la la-la la-eye-slash"></i>@lang('Disable')
                                                            </button>
                                                        @else
                                                            <button type="button" data-action="{{ route('admin.plans.loan.status', $plan->id) }}" data-question="@lang('Are you sure to enable this plan?')" class="btn btn-sm confirmationBtn btn-success">
