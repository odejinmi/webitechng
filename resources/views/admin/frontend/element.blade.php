...
@section('panel')
    <div class="row">
        <div class="col-md-12 mb-30">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.frontend.sections.content', $key) }}" class="" method="POST"
                                                                    ...
                                                                    <div class="card">
                                                                        <div class="card-body">
                                                                            ...
                                                                            <div class="text-center">
                                                                                <img src="{{ getImage('assets/images/frontend/' . $key . '/' . @$data->data_values->$imgKey, @$section->element->images->$imgKey->size) }}"
...
@push('style-lib')
    <link href="{{ asset('assets/thirdparty/css/fontawesome-iconpicker.min.css') }}" rel="stylesheet">
@endpush

@push('script-lib')
    <script src="{{ asset('assets/thirdparty/js/fontawesome-iconpicker.js') }}"></script>
@endpush
