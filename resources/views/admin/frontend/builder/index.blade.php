                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>&nbsp;</label>
                                        <button type="submit"
                                            class="btn btn-outline-primary w-100 h-45">@lang('Submit')</button>
                                    </div>
                                </div>
                            </div>
                        </form>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.frontend.manage.section.update', $pdata->id) }}" method="post">
                        ...
                        <button type="submit" class="btn btn-outline-primary w-100 h-45">@lang('Update Now')</button>
                    </form>
...
@push('script-lib')
    <script src="{{ asset('assets/thirdparty/js/jquery-sortable.js') }}"></script>
@endpush
