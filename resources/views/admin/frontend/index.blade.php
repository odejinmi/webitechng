                                                        ...
                                                        <div class="thumb">
                                                            <div class="col-12">
                                                                <div class="card">
                                                                    <div class="card-body">
                                                                        <div class="mb-2">
                                                                            <h5 class="mb-0">{{ __(keyToTitle(@$imgKey)) }}</h5>
                                                                        </div>
                
                                                                        <div class="text-center">
                                                                            <img src="{{ getImage('assets/images/frontend/' . $key . '/' . @$content->data_values->$imgKey, @$section->content->images->$imgKey->size) }}"
                                                ...
                                                <td>
                                                    <div class="customer-details d-block">
                                                        <a href="javascript:void(0)" class="thumb" width="50">
                                                            ...
                                                            <img width="50" src="{{ getImage('assets/images/frontend/' . $key . '/' . @$data->data_values->$firstKey, @$section->element->images->$firstKey->size) }}"
                                                                alt="@lang('image')">
                                                        </a>
                                                    </div>
                                                </td>
                                                    ...
                                                    @else
                                                        <a href="{{ route('admin.frontend.sections.element', [$key, $data->id]) }}"
                                                            class="btn btn-sm btn-outline-primary"><i
                                                                class="ti ti-edit"></i> @lang('Edit')</a>
                                                    @endif
                                                    <button class="btn btn-sm btn-outline-danger confirmationBtn"
                                                        data-action="{{ route('admin.frontend.remove', $data->id) }}"
                                                        data-question="@lang('Are you sure to remove this item?')"><i class="ti ti-trash"></i>
                                                        @lang('Remove')</button>
                                                </div>
                                            </td>
                                        </tr>
                                    ...
                                    @if ($type == 'icon')
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                @foreach ($icons as $selectKey => $options)
                                                <option value="<i class='icon fa {{ $options }} '></i>">{{ $options }}</option>
                                                @endforeach
                                                </select> 
                                            </div>
                                        </div>
                                                        ...
                                                        <div class="avatar-preview">
                                                            <div class="col-12">
                                                                <div class="card">
                                                                    <div class="card-body">
                                                                        <div class="text-center">
                                                                            <img src="{{ getImage('/', @$section->element->images->$imgKey->size) }}"
        ...
        @push('breadcrumb-plugins')
            @if ($section->element->modal)
                <a href="javascript:void(0)" class="btn btn-sm btn-outline-primary addBtn"><i
                        class="ti ti-plus"></i>@lang('Add New')</a>
            @else
