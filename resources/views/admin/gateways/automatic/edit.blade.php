                    ...
                    <div class="card-body">
                        <div class="payment-method-item block-item">
                            <div class="payment-method-header">
                                <img width="40" src="{{getImage(imagePath()['gateway']['path'].'/'. $gateway->image,imagePath()['gateway']['size'])}}" alt="" class="img-fluid ms-auto"> 
                                ...
                                <div class="payment-method-item block-item child--item">
                                            ...
                                            <div class="d-flex justify-content-between">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        ...
                                                        value="{{ $gatewayCurrency->name }}" required placeholder="Gateway Name" />
                                                </div>
                                                <div class="remove-btn">
                                                    <button type="button" class="btn btn-danger confirmationBtn"
                                                        ...
                                                        <i class="ti ti-trash me-2"></i>@lang('Remove')
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="payment-method-body">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4">
                                                <div class="card border-primary mt-2">
                                                    <h5 class="card-header bg-light-primary">@lang('Currency')</h5>
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group mb-3">
                                            ...
                                            @if ($parameters->where('global', false)->count() != 0)
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="card border-primary mt-4">
                                                        <h5 class="card-header bg-light-primary">@lang('Configuration')</h5>
                                                        <div class="card-body">
                                                            <div class="row">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <div class="form-group">
                                            ...
                                            <input disabled type="text" class="form-control"
                                                name="currency[{{ $currencyIndex }}][name]" required placeholder="Gateway Name"/>
                                        </div>
                                        <div class="remove-btn">
