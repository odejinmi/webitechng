                            ...
                            <div class="d-flex align-items-center"> 
                                ...
                                <div class="btn-group mb-2">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                      <li><a class="dropdown-item" href="{{route('admin.storefront.order.status',$data->trx.'?status=deliver')}}">Mark As Delivered</a></li>
                                      <li>
                                        <a class="dropdown-item" href="{{route('admin.storefront.order.status',$data->trx.'?status=decline')}}">Mark As Declined</a>
                                      </li> 
                                    </ul>
                                  </div>
                              </div>
                        ...
                        <div class="w-100">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check form-switch form-check-success">
                                    <input type="checkbox" class="form-check-input" @if ($storefront->status == 1) checked @endif name="status" id="status" /> 
                                </div>   
                                </div>  
                            </div>
                            <!--end::Input group--> 
