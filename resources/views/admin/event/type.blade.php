...
@section('panel')
                ...
                <div class="card-body p-0">
                    <div class="table-responsive--sm table-responsive">
                        <table class="table table--light style--two">
                            ...
                            <tbody>
                            @forelse($event_type as $eventtype)
                                <tr>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">@lang('Add Event Type')</h5>
                     
                </div>
                <form action="{{route('admin.event.type.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
    ...
    <div id="updatePropertyModel" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">@lang('Update Event Type')</h5>
                    
                </div>
                <form action="{{route('admin.event.type.update')}}" method="POST" enctype="multipart/form-data">
                    @csrf
...
@can(['admin.event.type.store'])
    <a href="javascript:void(0)" class="btn btn-sm btn-primary box--shadow1 text--small addProperty" ><i class="fa fa-fw fa-paper-plane"></i>@lang('Add Event Type')</a>
@endcan
@endpush
