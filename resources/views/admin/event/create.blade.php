                	...
                	<form action="{{route('admin.event.store')}}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" name="title" id="title" value="{{old('title')}}" class="form-control form-control-lg" placeholder="@lang('Enter Event Title')" maxlength="255" required="">
                                                </div>
                                                <div class="form-group mb-3">
                                                    <label for="title" class="font-weight-bold">@lang('Description')</label>
                                                    <textarea type="text" name="eventdescription" id="description" class="form-control form-control-lg" placeholder="@lang('Enter Event Description')" maxlength="500" required="">{{old('description')}}</textarea>
                                                </div>
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <select name="event_type" id="event_type" class="form-control form-control-lg" required="">
                                                        ...
                                                        @foreach($eventTypes as $eventType)
                                                            <option value="{{$eventType->id}}">{{__($eventType->name)}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" name="video_link" id="video_link" value="{{old('video_link')}}" class="form-control form-control-lg" placeholder="@lang('https://www.youtube.com/embed/example')" maxlength="255" required="">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="row mt-4 mb-4">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <div class="input-group mb-3"> 
                                                          <input type="date" id="sdate" class="form-control form-control-lg" value="{{old('sdate')}}" placeholder="@lang('Start Date')" name="sdate" aria-label="Start Date" aria-describedby="basic-sdate">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <div class="input-group mb-3"> 
                                                          <input type="time" id="stime" class="form-control form-control-lg" value="{{old('stime')}}" placeholder="@lang('Start Time')" name="stime" aria-label="Start Time" aria-describedby="basic-stime">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <div class="input-group mb-3"> 
                                                          <input type="date" id="edate" class="form-control form-control-lg" value="{{old('edate')}}" placeholder="@lang('End Date')" name="edate" aria-label="End Date" aria-describedby="basic-edate">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <div class="input-group mb-3"> 
                                                          <input type="time" id="etime" class="form-control form-control-lg" value="{{old('etime')}}" placeholder="@lang('End Time')" name="etime" aria-label="End Time" aria-describedby="basic-etime">
                                                    </div>
                                                </div>
                                            </div> 
                                        </div>  
                       	...
                       	<div class="form-group">
                            <button type="submit" class="btn btn-primary btn-block btn-lg"><i class="fa fa-fw fa-plus"></i> @lang('Create Event')</button>
                        </div>
                	</form>
                </div>
            </div>
                    ...
                    <div class="col-md-12 user-data">
                        <div class="form-group">
                            <div class="input-group mb-md-0 mb-4">
                                ...
                                <div class="col-md-2 mt-md-0 mb-2 text-right">
