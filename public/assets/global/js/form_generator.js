class FormGenerator{
    ...
    extraFields(fieldType){
        ...
        if (this.fieldType == 'file') {
            var field = `<select class="form-control select2-multi-select" name="extensions" multiple>
            ...
            addNew = `<button type="button" class="btn btn-sm btn-outline-primary addOption"><i class="ti ti-plus me-0"></i></button>`;
        ...
        return `
            <div class="form-group">
                <div class="input-group">
                    ...
                    <button class="btn btn-outline-danger input-group-text removeOption"><i class="las la-times"></i></button>
                </div>
            </div>
        `;
    }
        ...
        var formsHtml = `
            ...
            <div class="card-body">
                ...
                <div class="btn-group w-100">
                    <button type="button" class="btn btn-outline-primary editFormData" data-form_item='${JSON.stringify(formItem)}' data-update_id="${updateId}"><i class="las la-pen"></i></button>
                    <button type="button" class="btn btn-outline-danger removeFormData"><i class="ti ti-trash"></i></button>
                </div>
            </div>
        `;
        var html = `
    ...
    formEdit(element){
        ...
        formItem.options.forEach(option => {
            ...
            if(i != 0){
                isRemove = `
                    <button class="btn btn-outline-danger input-group-text removeOption"><i class="ti ti-x"></i></button>
                `;
            }
            if (i==0) {
                html += `
                    <div class="d-flex justify-content-between flex-wrap">
                        ...
                        <button type="button" class="btn btn-sm btn-outline-primary addOption"><i class="ti ti-plus me-0"></i></button>
                    </div>
                `;
            }
            i += 1;
